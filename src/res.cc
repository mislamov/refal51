...
/*SET*/	OJWAYYZPVSCMPS = arg_from;
/*INC*/	if (!INC(OJWAYYZPVSCMPS, arg_to)) goto sentence_after_1;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_g;
/*DEF*/	DataCursor r_g;
/*SET*/	l_g = AJLFVGUBFAAOVL;
/*SET*/	ESJWHDIZCOBZCN = AJLFVGUBFAAOVL;
/*INC*/	if (!INC(ESJWHDIZCOBZCN, ZYLNTRKDCPWSRT)) goto sentence_after_1;
	if (! isSymbolType(ESJWHDIZCOBZCN.container->type)) goto sentence_after_1;
/*SET*/	r_g = ESJWHDIZCOBZCN;
//// [ empty ] 
/*ISEMPTY*/	if (r_g!=0 && ZYLNTRKDCPWSRT != r_g) goto sentence_after_1;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor FWLQIJTVDWVXHR;
/*DEF*/	DataCursor CBLDVGYLWGBUSB;
/*DEF*/	DataCursor MBORXTLHCSMPXO;
/*SET*/	FWLQIJTVDWVXHR = OJWAYYZPVSCMPS;
/*INC*/	if (!INC(FWLQIJTVDWVXHR, arg_to)) goto sentence_after_1;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_n;
/*DEF*/	DataCursor r_n;
/*SET*/	l_n = IEPJSRDZJAZUJL;
/*SET*/	r_n = LCHHBFQMKIMWZO;
//// [ empty ] 
/*ISEMPTY*/	if (KJDQZJENPEVQGX!=0 && arg_to != KJDQZJENPEVQGX) goto sentence_after_1;
...
/*SET*/	QZHNBNFUVQNQQL = arg_from;
/*INC*/	if (!INC(QZHNBNFUVQNQQL, arg_to)) goto sentence_after_1;
	if (QZHNBNFUVQNQQL.container->type != text || *(QZHNBNFUVQNQQL.container->value.text + QZHNBNFUVQNQQL.index) != '0') goto sentence_after_1;
//// [ e.1 <any> ] 
/*DEF*/	DataCursor l_e;
/*DEF*/	DataCursor r_e;
/*SET*/	l_e = QZHNBNFUVQNQQL;
/*SET*/	r_e = QZHNBNFUVQNQQL;
/*JMP*/	goto label_RZJPXIOGVLIEXD_firststep;
...
/*SET*/	ZUZOSRKRUSVOJB = r_e;
/*INC*/	if (!INC(ZUZOSRKRUSVOJB, arg_to)) goto label_RZJPXIOGVLIEXD;
//// ISBRACKET 
...
//// [ empty ] 
/*ISEMPTY*/	if (RZMWZPOWKJILEF!=0 && RAAMDIGPNPUUHG != RZMWZPOWKJILEF) goto label_RZJPXIOGVLIEXD;
//// [ empty ] 
/*ISEMPTY*/	if (ZUZOSRKRUSVOJB!=0 && arg_to != ZUZOSRKRUSVOJB) goto label_RZJPXIOGVLIEXD;
...
/*INC*/	if (!INC(ZOTCJTNZXUGLSD, arg_to)) goto sentence_after_2;
...
/*INC*/	if (!INC(WLJFRIMPMYHCHZ, arg_to)) goto sentence_after_3;
...
/*INC*/	if (!INC(EHBBCPXIFBXVFB, arg_to)) goto sentence_after_4;
...
UBMJRMBSZTSSHF->append_copy(l_e, r_e, context); 
...
/*INC*/	if (!INC(ROEFWSJRXJHGUZ, arg_to)) goto sentence_after_1;
//// ISBRACKET 
...
/*SET*/	UDHNEFNJHAIMUC = YUPZWWEIQURPIX;
/*INC*/	if (!INC(UDHNEFNJHAIMUC, IQFLDUUVEOOWQC)) goto sentence_after_1;
	if (UDHNEFNJHAIMUC.container->type != text || *(UDHNEFNJHAIMUC.container->value.text + UDHNEFNJHAIMUC.index) != '1') goto sentence_after_1;
//// [ empty ] 
/*ISEMPTY*/	if (UDHNEFNJHAIMUC!=0 && IQFLDUUVEOOWQC != UDHNEFNJHAIMUC) goto sentence_after_1;
//// [ e.1 <any> ] 
/*DEF*/	DataCursor l_12;
/*DEF*/	DataCursor r_12;
/*SET*/	l_12 = ROEFWSJRXJHGUZ;
/*SET*/	r_12 = ROEFWSJRXJHGUZ;
...
/*SET*/	DZEZTOIDUKUHJZ = r_12;
/*INC*/	if (!INC(DZEZTOIDUKUHJZ, arg_to)) goto label_TBRECUYKABFCVK;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_n;
/*DEF*/	DataCursor r_n;
/*SET*/	l_n = EFCZZZBFKQDPQZ;
/*SET*/	r_n = IKFOBUCDHTHXDJ;
//// [ empty ] 
/*ISEMPTY*/	if (DZEZTOIDUKUHJZ!=0 && arg_to != DZEZTOIDUKUHJZ) goto label_TBRECUYKABFCVK;
...
/*SET*/	SODKJGHCWMBMXR = arg_from;
/*INC*/	if (!INC(SODKJGHCWMBMXR, arg_to)) goto sentence_after_2;
//// ISBRACKET 
...
/*INC*/	if (!INC(YUBZAZCPKHKTKY, LZNAYXQKQOYZWM)) goto sentence_after_2;
	if (YUBZAZCPKHKTKY.container->type != text || *(YUBZAZCPKHKTKY.container->value.text + YUBZAZCPKHKTKY.index) != '2') goto sentence_after_2;
//// [ empty ] 
/*ISEMPTY*/	if (YUBZAZCPKHKTKY!=0 && LZNAYXQKQOYZWM != YUBZAZCPKHKTKY) goto sentence_after_2;
//// [ e.1 <any> ] 
/*DEF*/	DataCursor l_12;
/*DEF*/	DataCursor r_12;
/*SET*/	l_12 = SODKJGHCWMBMXR;
/*SET*/	r_12 = SODKJGHCWMBMXR;
/*JMP*/	goto label_SGEKYRGZVXDHPO_firststep;
...
/*SET*/	AMVAFYRARXSVKH = r_12;
/*INC*/	if (!INC(AMVAFYRARXSVKH, arg_to)) goto label_SGEKYRGZVXDHPO;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_n;
/*DEF*/	DataCursor r_n;
/*SET*/	l_n = TQDIHERSIGBHZJ;
/*SET*/	r_n = ZUJXMMYSPNARAE;
//// [ empty ] 
/*ISEMPTY*/	if (AMVAFYRARXSVKH!=0 && arg_to != AMVAFYRARXSVKH) goto label_SGEKYRGZVXDHPO;
...
/*INC*/	if (!INC(CGFMZKGIPDFODK, arg_to)) goto sentence_after_1;
...
/*DEF*/	DataCursor l_h;
/*DEF*/	DataCursor r_h;
/*SET*/	l_h = CGFMZKGIPDFODK;
/*SET*/	JMJQWIQPUOQHIM = CGFMZKGIPDFODK;
/*INC*/	if (!INC(JMJQWIQPUOQHIM, arg_to)) goto sentence_after_1;
	if (! isSymbolType(JMJQWIQPUOQHIM.container->type)) goto sentence_after_1;
/*SET*/	r_h = JMJQWIQPUOQHIM;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor VFVUZWYVIJGFUL;
/*DEF*/	DataCursor LKJDUHSJAFBTLK;
/*DEF*/	DataCursor MFQRMYJFJNHHSS;
/*SET*/	VFVUZWYVIJGFUL = r_h;
/*INC*/	if (!INC(VFVUZWYVIJGFUL, arg_to)) goto sentence_after_1;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_1;
/*DEF*/	DataCursor r_1;
/*SET*/	l_1 = LKJDUHSJAFBTLK;
/*SET*/	r_1 = MFQRMYJFJNHHSS;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor QCTYDTEAMDCJBP;
/*DEF*/	DataCursor RHTNEGYIWXGCJW;
/*DEF*/	DataCursor LGRSMEAEARWTVJ;
/*SET*/	QCTYDTEAMDCJBP = VFVUZWYVIJGFUL;
/*INC*/	if (!INC(QCTYDTEAMDCJBP, arg_to)) goto sentence_after_1;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_n1;
/*DEF*/	DataCursor r_n1;
/*SET*/	l_n1 = VRUIHOSWKIFYGT;
/*SET*/	r_n1 = VRUIHOSWKIFYGT;
/*JMP*/	goto label_TGONZLTJHGAUHN_firststep;
label_TGONZLTJHGAUHN: 
/*INC*/	if (!INC(r_n1, YDHACWYHSGEWZM)) goto sentence_after_1;
label_TGONZLTJHGAUHN_firststep: 
//// [ &.name <any> ] 
/*DEF*/	DataCursor IHREQGJFWKJSMT;
/*SET*/	IHREQGJFWKJSMT = r_n1;
 if (!SLIDE(IHREQGJFWKJSMT, YDHACWYHSGEWZM, l_h, r_h)) goto label_TGONZLTJHGAUHN;
//// [ e.1 ] 
/*DEF*/	DataCursor l_n2;
/*DEF*/	DataCursor r_n2;
/*SET*/	l_n2 = IHREQGJFWKJSMT;
/*SET*/	r_n2 = YDHACWYHSGEWZM;
//// [ empty ] 
/*ISEMPTY*/	if (SJBAOIOJLWHYPN!=0 && arg_to != SJBAOIOJLWHYPN) goto label_TGONZLTJHGAUHN;
...
CHJCCDYRFVVRIV->append_copy(l_h, r_h, context); 
...
UYEEGFIVDRCYGU->append_copy(l_1, r_1, context); 
UYEEGFIVDRCYGU->append_copy(l_h, r_h, context); 
DataChain* RQDREDAKUBNFGU = new DataChain(); 
result->append(newRefStructBrackets(RQDREDAKUBNFGU)); 
RQDREDAKUBNFGU->append_copy(l_2, r_2, context); 
DataChain* PROQYLOBCWQXKZ = new DataChain(); 
result->append(newRefStructBrackets(PROQYLOBCWQXKZ)); 
PROQYLOBCWQXKZ->append_copy(l_n1, r_n1, context); 
PROQYLOBCWQXKZ->append_copy(l_n2, r_n2, context); 
return result;
}
sentence_after_1: 
...
/*SET*/	MAUSJGMHCMHGDN = arg_from;
/*INC*/	if (!INC(MAUSJGMHCMHGDN, arg_to)) goto sentence_after_2;
...
/*DEF*/	DataCursor l_h;
/*DEF*/	DataCursor r_h;
/*SET*/	l_h = MAUSJGMHCMHGDN;
/*SET*/	MPHNQKAMHURKTR = MAUSJGMHCMHGDN;
/*INC*/	if (!INC(MPHNQKAMHURKTR, arg_to)) goto sentence_after_2;
	if (! isSymbolType(MPHNQKAMHURKTR.container->type)) goto sentence_after_2;
/*SET*/	r_h = MPHNQKAMHURKTR;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor FFACLVGRZKKLDA;
/*DEF*/	DataCursor CLLTEOJOMONXRQ;
/*DEF*/	DataCursor YJZGINRNNZWACX;
/*SET*/	FFACLVGRZKKLDA = r_h;
/*INC*/	if (!INC(FFACLVGRZKKLDA, arg_to)) goto sentence_after_2;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_1;
/*DEF*/	DataCursor r_1;
/*SET*/	l_1 = CLLTEOJOMONXRQ;
/*SET*/	r_1 = YJZGINRNNZWACX;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor XAEDRWUDXZRFUS;
/*DEF*/	DataCursor EWJTBOXVYNFHKS;
/*DEF*/	DataCursor TCENAUMNDDXFDM;
/*SET*/	XAEDRWUDXZRFUS = FFACLVGRZKKLDA;
/*INC*/	if (!INC(XAEDRWUDXZRFUS, arg_to)) goto sentence_after_2;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_n1;
/*DEF*/	DataCursor r_n1;
/*SET*/	l_n1 = DZSXTTOBBGQNGV;
/*SET*/	r_n1 = DZSXTTOBBGQNGV;
/*JMP*/	goto label_FCPYPCKQCHBDDZ_firststep;
label_FCPYPCKQCHBDDZ: 
/*INC*/	if (!INC(r_n1, VPJGOJOGLMKXGB)) goto sentence_after_2;
label_FCPYPCKQCHBDDZ_firststep: 
//// [ &.name <any> ] 
/*DEF*/	DataCursor WRXBZMQRLXVOBT;
/*SET*/	WRXBZMQRLXVOBT = r_n1;
 if (!SLIDE(WRXBZMQRLXVOBT, VPJGOJOGLMKXGB, l_h, r_h)) goto label_FCPYPCKQCHBDDZ;
//// [ e.1 ] 
/*DEF*/	DataCursor l_n2;
/*DEF*/	DataCursor r_n2;
/*SET*/	l_n2 = WRXBZMQRLXVOBT;
/*SET*/	r_n2 = VPJGOJOGLMKXGB;
//// [ empty ] 
/*ISEMPTY*/	if (VZCAUTDCCKXAAY!=0 && arg_to != VZCAUTDCCKXAAY) goto label_FCPYPCKQCHBDDZ;
...
HUBSJOLLMSQSGH->append_copy(l_1, r_1, context); 
DataChain* MCPHELSOTFLBGS = new DataChain(); 
result->append(newRefStructBrackets(MCPHELSOTFLBGS)); 
MCPHELSOTFLBGS->append_copy(l_2, r_2, context); 
MCPHELSOTFLBGS->append_copy(l_h, r_h, context); 
DataChain* FNPCUZSRUPCHYN = new DataChain(); 
result->append(newRefStructBrackets(FNPCUZSRUPCHYN)); 
FNPCUZSRUPCHYN->append_copy(l_n1, r_n1, context); 
FNPCUZSRUPCHYN->append_copy(l_n2, r_n2, context); 
return result;
}
sentence_after_2: 
...
/*DEF*/	DataCursor r_v;
/*SET*/	l_v = arg_from;
/*SET*/	VZHCPQUGRIWNIQ = arg_from;
/*INC*/	if (!INC(VZHCPQUGRIWNIQ, arg_to)) goto sentence_after_1;
	if (! isSymbolType(VZHCPQUGRIWNIQ.container->type)) goto sentence_after_1;
/*SET*/	r_v = VZHCPQUGRIWNIQ;
//// [ e.1 <any> ] 
/*DEF*/	DataCursor l_e;
/*DEF*/	DataCursor r_e;
/*SET*/	l_e = r_v;
/*SET*/	r_e = r_v;
/*JMP*/	goto label_XDFJPWPXFBLKPN_firststep;
...
/*SET*/	PEELFJMTKUQPZO = r_e;
/*INC*/	if (!INC(PEELFJMTKUQPZO, arg_to)) goto label_XDFJPWPXFBLKPN;
//// ISBRACKET 
...
/*SET*/	l_not = MWNLMBUPMKTLPT;
/*SET*/	r_not = NDMPDSYDSGVFPE;
//// [ empty ] 
/*ISEMPTY*/	if (PEELFJMTKUQPZO!=0 && arg_to != PEELFJMTKUQPZO) goto label_XDFJPWPXFBLKPN;
...
NEMWBORIFSUQHC->append_copy(l_v, r_v, context); 
NEMWBORIFSUQHC->append_copy(l_e, r_e, context); 
DataChain* ESKMKHSSMVNONW = new DataChain(); 
NEMWBORIFSUQHC->append(newRefStructBrackets(ESKMKHSSMVNONW)); 
ESKMKHSSMVNONW->append_copy(l_not, r_not, context); 
...
PQFOVIUSSQFQWE->append_copy(l_e, r_e, context); 
...
HTXDZUJTLNTXMR->append_copy(l_not, r_not, context); 
...
/*SET*/	LYDNILQADOJSKK = r_e;
/*INC*/	if (!INC(LYDNILQADOJSKK, arg_to)) goto label_JXXWTLGGKYTBIO;
//// ISBRACKET 
...
/*SET*/	PBYJZWYYOJUOTH = VFXAHHJMBOCLJA;
/*INC*/	if (!INC(PBYJZWYYOJUOTH, RINTDWCLDVDXRO)) goto label_JXXWTLGGKYTBIO;
...
/*DEF*/	DataCursor l_s;
/*DEF*/	DataCursor r_s;
/*SET*/	l_s = PBYJZWYYOJUOTH;
/*SET*/	WMLVRGLFZDZDBT = PBYJZWYYOJUOTH;
/*INC*/	if (!INC(WMLVRGLFZDZDBT, RINTDWCLDVDXRO)) goto label_JXXWTLGGKYTBIO;
	if (! isSymbolType(WMLVRGLFZDZDBT.container->type)) goto label_JXXWTLGGKYTBIO;
/*SET*/	r_s = WMLVRGLFZDZDBT;
//// [ empty ] 
/*ISEMPTY*/	if (r_s!=0 && RINTDWCLDVDXRO != r_s) goto label_JXXWTLGGKYTBIO;
//// [ empty ] 
/*ISEMPTY*/	if (LYDNILQADOJSKK!=0 && arg_to != LYDNILQADOJSKK) goto label_JXXWTLGGKYTBIO;

// подстановка 
context->prepareSubstitute(); 
result->append_copy(l_s, r_s, context); 
return result;
}
sentence_after_1: 
...
/*DEF*/	DataCursor r_v;
/*SET*/	l_v = arg_from;
/*SET*/	AZNMOIJOIVVGOB = arg_from;
/*INC*/	if (!INC(AZNMOIJOIVVGOB, arg_to)) goto sentence_after_2;
	if (! isSymbolType(AZNMOIJOIVVGOB.container->type)) goto sentence_after_2;
/*SET*/	r_v = AZNMOIJOIVVGOB;
//// [ e.1 <any> ] 
/*DEF*/	DataCursor l_e;
/*DEF*/	DataCursor r_e;
/*SET*/	l_e = r_v;
/*SET*/	r_e = r_v;
/*JMP*/	goto label_QPNCKWVNHKEBMT_firststep;
...
/*SET*/	DHVYGKJISUXHAT = r_e;
/*INC*/	if (!INC(DHVYGKJISUXHAT, arg_to)) goto label_QPNCKWVNHKEBMT;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_not;
/*DEF*/	DataCursor r_not;
/*SET*/	l_not = MUUDQBHMKNHFXA;
/*SET*/	r_not = XQXKJLZZQTSJFA;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor EEDFUUJKOLXJOQ;
/*DEF*/	DataCursor KDVFEPVLHVHRWT;
/*DEF*/	DataCursor FDUKXFFJPSSWYX;
/*SET*/	EEDFUUJKOLXJOQ = DHVYGKJISUXHAT;
/*INC*/	if (!INC(EEDFUUJKOLXJOQ, arg_to)) goto label_QPNCKWVNHKEBMT;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_Wr;
/*DEF*/	DataCursor r_Wr;
/*SET*/	l_Wr = KDVFEPVLHVHRWT;
/*SET*/	r_Wr = FDUKXFFJPSSWYX;
//// [ empty ] 
/*ISEMPTY*/	if (EEDFUUJKOLXJOQ!=0 && arg_to != EEDFUUJKOLXJOQ) goto label_QPNCKWVNHKEBMT;
...
DQLAHYGGYLJDDJ->append_copy(l_v, r_v, context); 
DQLAHYGGYLJDDJ->append_copy(l_Wr, r_Wr, context); 
...
HMLTEDZLODSRKE->append_copy(l_Wr, r_Wr, context); 
...
/*SET*/	INOVGZDTHUNWOO = arg_from;
/*INC*/	if (!INC(INOVGZDTHUNWOO, arg_to)) goto sentence_after_1;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_Sw;
/*DEF*/	DataCursor r_Sw;
/*SET*/	l_Sw = XVJJMPSVKNHKWJ;
/*SET*/	r_Sw = OPMMLEBKSUCVZQ;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor LYQNWCMBVBHRML;
/*DEF*/	DataCursor OWPJBWYVWTGTOQ;
/*DEF*/	DataCursor NMICXAPZARKNNX;
/*SET*/	LYQNWCMBVBHRML = INOVGZDTHUNWOO;
/*INC*/	if (!INC(LYQNWCMBVBHRML, arg_to)) goto sentence_after_1;
//// ISBRACKET 
...
/*SET*/	TUUFARZROSDQWS = OWPJBWYVWTGTOQ;
 if (!SLIDE(TUUFARZROSDQWS, NMICXAPZARKNNX, l_Sw, r_Sw)) goto sentence_after_1;
//// [ e.1 ] 
/*DEF*/	DataCursor l_Wr;
/*DEF*/	DataCursor r_Wr;
/*SET*/	l_Wr = TUUFARZROSDQWS;
/*SET*/	r_Wr = NMICXAPZARKNNX;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor MTCJGHECQUDOSR;
/*DEF*/	DataCursor TJXYAAYKQRXYCR;
/*DEF*/	DataCursor XUWJXNPQJNBKCP;
/*SET*/	MTCJGHECQUDOSR = LYQNWCMBVBHRML;
/*INC*/	if (!INC(MTCJGHECQUDOSR, arg_to)) goto sentence_after_1;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_s;
/*DEF*/	DataCursor r_s;
/*SET*/	l_s = TJXYAAYKQRXYCR;
/*SET*/	DMOKALXAPEMVBQ = TJXYAAYKQRXYCR;
/*INC*/	if (!INC(DMOKALXAPEMVBQ, XUWJXNPQJNBKCP)) goto sentence_after_1;
	if (! isSymbolType(DMOKALXAPEMVBQ.container->type)) goto sentence_after_1;
/*SET*/	r_s = DMOKALXAPEMVBQ;
//// [ e.1 ] 
/*DEF*/	DataCursor l_n;
/*DEF*/	DataCursor r_n;
/*SET*/	l_n = r_s;
/*SET*/	r_n = XUWJXNPQJNBKCP;
//// [ empty ] 
/*ISEMPTY*/	if (MTCJGHECQUDOSR!=0 && arg_to != MTCJGHECQUDOSR) goto sentence_after_1;
...
/*SET*/	LZSVXZKUTAPPWG = arg_from;
/*INC*/	if (!INC(LZSVXZKUTAPPWG, arg_to)) goto sentence_after_2;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_Sw;
/*DEF*/	DataCursor r_Sw;
/*SET*/	l_Sw = ZPDPYZKZCVBNTC;
/*SET*/	r_Sw = VFXSXPJAOXTFHV;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor XXYTGOKRCXAETA;
/*DEF*/	DataCursor UQGNDMPHWZYIAY;
/*DEF*/	DataCursor ABJRQGEPPXYJST;
/*SET*/	XXYTGOKRCXAETA = LZSVXZKUTAPPWG;
/*INC*/	if (!INC(XXYTGOKRCXAETA, arg_to)) goto sentence_after_2;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_s1;
/*DEF*/	DataCursor r_s1;
/*SET*/	l_s1 = UQGNDMPHWZYIAY;
/*SET*/	TYZUVLDVYBSUXK = UQGNDMPHWZYIAY;
/*INC*/	if (!INC(TYZUVLDVYBSUXK, ABJRQGEPPXYJST)) goto sentence_after_2;
	if (! isSymbolType(TYZUVLDVYBSUXK.container->type)) goto sentence_after_2;
/*SET*/	r_s1 = TYZUVLDVYBSUXK;
//// [ `a` <any> ] 
/*DEF*/	DataCursor BMFZVRTNOVIDZN;
/*SET*/	BMFZVRTNOVIDZN = r_s1;
/*INC*/	if (!INC(BMFZVRTNOVIDZN, ABJRQGEPPXYJST)) goto sentence_after_2;
...
/*DEF*/	DataCursor l_s2;
/*DEF*/	DataCursor r_s2;
/*SET*/	l_s2 = BMFZVRTNOVIDZN;
/*SET*/	PGHOZVAFMSNSNQ = BMFZVRTNOVIDZN;
/*INC*/	if (!INC(PGHOZVAFMSNSNQ, ABJRQGEPPXYJST)) goto sentence_after_2;
	if (! isSymbolType(PGHOZVAFMSNSNQ.container->type)) goto sentence_after_2;
/*SET*/	r_s2 = PGHOZVAFMSNSNQ;
//// [ e.1 <any> ] 
/*DEF*/	DataCursor l_e;
/*DEF*/	DataCursor r_e;
/*SET*/	l_e = r_s2;
/*SET*/	r_e = r_s2;
/*JMP*/	goto label_IVMVUBCWTFSRQT_firststep;
label_IVMVUBCWTFSRQT: 
/*INC*/	if (!INC(r_e, ABJRQGEPPXYJST)) goto sentence_after_2;
label_IVMVUBCWTFSRQT_firststep: 
//// [ &.name <any> ] 
/*DEF*/	DataCursor MKNEPBHOWEJAZH;
/*SET*/	MKNEPBHOWEJAZH = r_e;
 if (!SLIDE(MKNEPBHOWEJAZH, ABJRQGEPPXYJST, l_Sw, r_Sw)) goto label_IVMVUBCWTFSRQT;
//// [ e.1 ] 
/*DEF*/	DataCursor l_Wr;
/*DEF*/	DataCursor r_Wr;
/*SET*/	l_Wr = MKNEPBHOWEJAZH;
/*SET*/	r_Wr = ABJRQGEPPXYJST;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor YSXTWWTAIDYAXY;
/*DEF*/	DataCursor QLEPRXIBEXXYFV;
/*DEF*/	DataCursor SDDYGTHCUYYFWP;
/*SET*/	YSXTWWTAIDYAXY = XXYTGOKRCXAETA;
/*INC*/	if (!INC(YSXTWWTAIDYAXY, arg_to)) goto label_IVMVUBCWTFSRQT;
//// ISBRACKET 
...
/*INC*/	if (!INC(JSFYBGLGZMBINT, SDDYGTHCUYYFWP)) goto label_IVMVUBCWTFSRQT;
...
//// [ empty ] 
/*ISEMPTY*/	if (YSXTWWTAIDYAXY!=0 && arg_to != YSXTWWTAIDYAXY) goto label_IVMVUBCWTFSRQT;
...
OTKGNGUPHPKXEA->append_copy(l_Sw, r_Sw, context); 
DataChain* TOWZABSDNVQHKF = new DataChain(); 
ATTNHODTONPYZW->append(newRefStructBrackets(TOWZABSDNVQHKF)); 
TOWZABSDNVQHKF->append_copy(l_e, r_e, context); 
TOWZABSDNVQHKF->append_copy(l_Sw, r_Sw, context); 
TOWZABSDNVQHKF->append_copy(l_Wr, r_Wr, context); 
DataChain* CMOFISFRFQGVPM = new DataChain(); 
ATTNHODTONPYZW->append(newRefStructBrackets(CMOFISFRFQGVPM)); 
CMOFISFRFQGVPM->append_copy(l_n, r_n, context); 
...
CLFKCYZOBGHTUO->append_copy(l_1, r_1, context); 
...
XRAJVPRECWGXXP->append_copy(l_1, r_1, context); 
...
SWCGMMVEDEWDMF->append_copy(l_1, r_1, context); 
...
WKKXLCBHQKVCSW->append_copy(l_1, r_1, context); 
...
JEBKRJLPGFGRAT->append_copy(l_1, r_1, context); 
...
ZBSGUVZIFNHYXW->append_copy(l_1, r_1, context); 
...
EPWZOLHUSLRKVW->append_copy(l_1, r_1, context); 
...
PNVGZMIIZWUDWD->append_copy(l_1, r_1, context); 
...
FZLKTBQDXGYYIU->append_copy(l_1, r_1, context); 
...
/*DEF*/	DataCursor r_1;
/*SET*/	l_1 = arg_from;
/*SET*/	YERTAHNEXHUQMJ = arg_from;
/*INC*/	if (!INC(YERTAHNEXHUQMJ, arg_to)) goto sentence_after_1;
	if (! isSymbolType(YERTAHNEXHUQMJ.container->type)) goto sentence_after_1;
/*SET*/	r_1 = YERTAHNEXHUQMJ;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor ICBMUSQDKLASOL;
/*DEF*/	DataCursor WJXPTXXEUMZFWY;
/*DEF*/	DataCursor UCPABQSEFFUNQP;
/*SET*/	ICBMUSQDKLASOL = r_1;
/*INC*/	if (!INC(ICBMUSQDKLASOL, arg_to)) goto sentence_after_1;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_21;
/*DEF*/	DataCursor r_21;
/*SET*/	l_21 = WJXPTXXEUMZFWY;
/*SET*/	r_21 = WJXPTXXEUMZFWY;
/*JMP*/	goto label_KFNNBECBBCJPDY_firststep;
label_KFNNBECBBCJPDY: 
/*INC*/	if (!INC(r_21, UCPABQSEFFUNQP)) goto sentence_after_1;
label_KFNNBECBBCJPDY_firststep: 
//// [ &.name <any> ] 
/*DEF*/	DataCursor JLIBITLLPLXELR;
/*SET*/	JLIBITLLPLXELR = r_21;
 if (!SLIDE(JLIBITLLPLXELR, UCPABQSEFFUNQP, l_1, r_1)) goto label_KFNNBECBBCJPDY;
//// [ e.1 ] 
/*DEF*/	DataCursor l_22;
/*DEF*/	DataCursor r_22;
/*SET*/	l_22 = JLIBITLLPLXELR;
/*SET*/	r_22 = UCPABQSEFFUNQP;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor DKEXDTQUVPTTEY;
/*DEF*/	DataCursor HTLQLBBBVOQOZK;
/*DEF*/	DataCursor YNAYYRBAQMYJHZ;
/*SET*/	DKEXDTQUVPTTEY = ICBMUSQDKLASOL;
/*INC*/	if (!INC(DKEXDTQUVPTTEY, arg_to)) goto label_KFNNBECBBCJPDY;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_3;
/*DEF*/	DataCursor r_3;
/*SET*/	l_3 = HTLQLBBBVOQOZK;
/*SET*/	r_3 = YNAYYRBAQMYJHZ;
//// [ empty ] 
/*ISEMPTY*/	if (DKEXDTQUVPTTEY!=0 && arg_to != DKEXDTQUVPTTEY) goto label_KFNNBECBBCJPDY;
...
/*DEF*/	DataCursor r_1;
/*SET*/	l_1 = arg_from;
/*SET*/	XNDSIYFSEXWBIO = arg_from;
/*INC*/	if (!INC(XNDSIYFSEXWBIO, arg_to)) goto sentence_after_2;
	if (! isSymbolType(XNDSIYFSEXWBIO.container->type)) goto sentence_after_2;
/*SET*/	r_1 = XNDSIYFSEXWBIO;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor EWQVQRTCDLPQMV;
/*DEF*/	DataCursor JIFVGYMKGOTZJM;
/*DEF*/	DataCursor NZQTMRPNDEVNMT;
/*SET*/	EWQVQRTCDLPQMV = r_1;
/*INC*/	if (!INC(EWQVQRTCDLPQMV, arg_to)) goto sentence_after_2;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_2;
/*DEF*/	DataCursor r_2;
/*SET*/	l_2 = JIFVGYMKGOTZJM;
/*SET*/	r_2 = NZQTMRPNDEVNMT;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor HJITSSPAQNJRDO;
/*DEF*/	DataCursor YJWPYATMLEYQSV;
/*DEF*/	DataCursor KPAMSVBMVXRLLI;
/*SET*/	HJITSSPAQNJRDO = EWQVQRTCDLPQMV;
/*INC*/	if (!INC(HJITSSPAQNJRDO, arg_to)) goto sentence_after_2;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_31;
/*DEF*/	DataCursor r_31;
/*SET*/	l_31 = YJWPYATMLEYQSV;
/*SET*/	r_31 = YJWPYATMLEYQSV;
/*JMP*/	goto label_VFEDKJIGAVYXJV_firststep;
label_VFEDKJIGAVYXJV: 
/*INC*/	if (!INC(r_31, KPAMSVBMVXRLLI)) goto sentence_after_2;
label_VFEDKJIGAVYXJV_firststep: 
//// [ &.name <any> ] 
/*DEF*/	DataCursor EQVRBACUIGAIPY;
/*SET*/	EQVRBACUIGAIPY = r_31;
 if (!SLIDE(EQVRBACUIGAIPY, KPAMSVBMVXRLLI, l_1, r_1)) goto label_VFEDKJIGAVYXJV;
//// [ e.1 ] 
/*DEF*/	DataCursor l_32;
/*DEF*/	DataCursor r_32;
/*SET*/	l_32 = EQVRBACUIGAIPY;
/*SET*/	r_32 = KPAMSVBMVXRLLI;
//// [ empty ] 
/*ISEMPTY*/	if (HJITSSPAQNJRDO!=0 && arg_to != HJITSSPAQNJRDO) goto label_VFEDKJIGAVYXJV;
...
/*DEF*/	DataCursor r_1;
/*SET*/	l_1 = arg_from;
/*SET*/	HBBXIPBZNCWHRB = arg_from;
/*INC*/	if (!INC(HBBXIPBZNCWHRB, arg_to)) goto sentence_after_3;
	if (! isSymbolType(HBBXIPBZNCWHRB.container->type)) goto sentence_after_3;
/*SET*/	r_1 = HBBXIPBZNCWHRB;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor LIRIZXOQPTQQWE;
/*DEF*/	DataCursor AAFJEQIOZPYFAU;
/*DEF*/	DataCursor UQMVHXKMNXMSYA;
/*SET*/	LIRIZXOQPTQQWE = r_1;
/*INC*/	if (!INC(LIRIZXOQPTQQWE, arg_to)) goto sentence_after_3;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_2;
/*DEF*/	DataCursor r_2;
/*SET*/	l_2 = AAFJEQIOZPYFAU;
/*SET*/	r_2 = UQMVHXKMNXMSYA;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor MPTLZANOTLSLWU;
/*DEF*/	DataCursor HTFQJRRWBWHMQH;
/*DEF*/	DataCursor ZKHDKCRFVBEIYI;
/*SET*/	MPTLZANOTLSLWU = LIRIZXOQPTQQWE;
/*INC*/	if (!INC(MPTLZANOTLSLWU, arg_to)) goto sentence_after_3;
//// ISBRACKET 
...
//// [ empty ] 
/*ISEMPTY*/	if (MPTLZANOTLSLWU!=0 && arg_to != MPTLZANOTLSLWU) goto sentence_after_3;
...
//// [ empty ] 
/*ISEMPTY*/	if (PVFVPZHYUJABTQ!=0 && arg_to != PVFVPZHYUJABTQ) goto sentence_after_1;
...
/*SET*/	r_G = WWTBKDOGKEMHIB;
//// [ s.1 <any> ] 
/*DEF*/	DataCursor YXRNXSXRZLETBQ;
/*DEF*/	DataCursor l_A;
/*DEF*/	DataCursor r_A;
/*SET*/	l_A = r_G;
/*SET*/	YXRNXSXRZLETBQ = r_G;
...
/*SET*/	r_A = YXRNXSXRZLETBQ;
//// [ `a` <any> ] 
/*DEF*/	DataCursor EXKRQOIERNAPLQ;
/*SET*/	EXKRQOIERNAPLQ = r_A;
/*INC*/	if (!INC(EXKRQOIERNAPLQ, arg_to)) goto sentence_after_2;
...
/*DEF*/	DataCursor l_AA;
/*DEF*/	DataCursor r_AA;
/*SET*/	l_AA = EXKRQOIERNAPLQ;
/*SET*/	YJPQOUBVJSEBAL = EXKRQOIERNAPLQ;
...
/*SET*/	r_AA = YJPQOUBVJSEBAL;
//// [ empty ] 
/*ISEMPTY*/	if (r_AA!=0 && arg_to != r_AA) goto sentence_after_2;

// подстановка 
context->prepareSubstitute(); 
result->append_copy(l_A, r_A, context); 
result->append(newRefText("=")); 
result->append_copy(l_AA, r_AA, context); 
return result;
}
sentence_after_2: 
...
/*SET*/	r_G = WYCZTWZZVEWXOT;
//// [ &.name <any> ] 
/*DEF*/	DataCursor AKUDKPEDUPKCZL;
/*SET*/	AKUDKPEDUPKCZL = r_G;
 if (!SLIDE(AKUDKPEDUPKCZL, arg_to, l_G, r_G)) goto sentence_after_3;
//// [ `a` <any> ] 
/*DEF*/	DataCursor HWUSKDNEVDCPLB;
/*SET*/	HWUSKDNEVDCPLB = AKUDKPEDUPKCZL;
/*INC*/	if (!INC(HWUSKDNEVDCPLB, arg_to)) goto sentence_after_3;
...
/*DEF*/	DataCursor l_AA;
/*DEF*/	DataCursor r_AA;
/*SET*/	l_AA = HWUSKDNEVDCPLB;
/*SET*/	KLPJMPFDCYQTRC = HWUSKDNEVDCPLB;
...
/*DEF*/	DataCursor l_BB;
/*DEF*/	DataCursor r_BB;
/*SET*/	l_BB = CUPRYJAUTEUVCZ;
/*SET*/	VICTHRXSXCLPRG = CUPRYJAUTEUVCZ;
/*INC*/	if (!INC(VICTHRXSXCLPRG, arg_to)) goto sentence_after_3;
	if (! isSymbolType(VICTHRXSXCLPRG.container->type)) goto sentence_after_3;
/*SET*/	r_BB = VICTHRXSXCLPRG;
//// [ e.1 ] 
/*DEF*/	DataCursor l_e;
/*DEF*/	DataCursor r_e;
/*SET*/	l_e = r_BB;
...
DIRXXGVZQMEYRO->append_copy(l_G, r_G, context); 
DIRXXGVZQMEYRO->append_copy(l_G, r_G, context); 
...
VFICHQNIVFJZAU->append_copy(l_AA, r_AA, context); 
VFICHQNIVFJZAU->append_copy(l_BB, r_BB, context); 
...
QFDFTGMOPSRGPU->append_copy(l_AA, r_AA, context); 
QFDFTGMOPSRGPU->append_copy(l_BB, r_BB, context); 
context->pushExecuteCall(QFDFTGMOPSRGPU_execbr);
context->pushExecuteCall(VFICHQNIVFJZAU_execbr);
DIRXXGVZQMEYRO->append_copy(l_e, r_e, context); 
...
/*INC*/	if (!INC(GXTUHLCVSPIHAZ, arg_to)) goto sentence_after_4;
...
/*INC*/	if (!INC(MXCDBHUMRGJQMV, arg_to)) goto sentence_after_4;
...
/*INC*/	if (!INC(NKYRTNSJVWZXSS, arg_to)) goto sentence_after_4;
...
/*INC*/	if (!INC(QXNJOMUYJNJUWR, arg_to)) goto sentence_after_4;
	if (! isSymbolType(QXNJOMUYJNJUWR.container->type)) goto sentence_after_4;
/*SET*/	r_s = QXNJOMUYJNJUWR;
//// [ `a` <any> ] 
/*DEF*/	DataCursor SYXWQYYXCSZPOK;
/*SET*/	SYXWQYYXCSZPOK = r_s;
/*INC*/	if (!INC(SYXWQYYXCSZPOK, arg_to)) goto sentence_after_4;
...
/*INC*/	if (!INC(LWJDRLTBSCIEDP, arg_to)) goto sentence_after_4;
...
WAKZTGJHXAUNFQ->append_copy(l_G, r_G, context); 
WAKZTGJHXAUNFQ->append_copy(l_G, r_G, context); 
WAKZTGJHXAUNFQ->append(newRefText("=")); 
WAKZTGJHXAUNFQ->append_copy(l_AA, r_AA, context); 
WAKZTGJHXAUNFQ->append_copy(l_e, r_e, context); 
...
/*INC*/	if (!INC(JVXIOHNJQRJSHY, arg_to)) goto sentence_after_5;
	if (! isSymbolType(JVXIOHNJQRJSHY.container->type)) goto sentence_after_5;
/*SET*/	r_G = JVXIOHNJQRJSHY;
//// [ s.1 <any> ] 
/*DEF*/	DataCursor MDOVWGEFHJESVH;
/*DEF*/	DataCursor l_s;
/*DEF*/	DataCursor r_s;
/*SET*/	l_s = r_G;
/*SET*/	MDOVWGEFHJESVH = r_G;
/*INC*/	if (!INC(MDOVWGEFHJESVH, arg_to)) goto sentence_after_5;
	if (! isSymbolType(MDOVWGEFHJESVH.container->type)) goto sentence_after_5;
/*SET*/	r_s = MDOVWGEFHJESVH;
//// [ `a` <any> ] 
/*DEF*/	DataCursor TIZIOJLJDPMOXB;
/*SET*/	TIZIOJLJDPMOXB = r_s;
/*INC*/	if (!INC(TIZIOJLJDPMOXB, arg_to)) goto sentence_after_5;
...
/*DEF*/	DataCursor l_AA;
/*DEF*/	DataCursor r_AA;
/*SET*/	l_AA = TIZIOJLJDPMOXB;
/*SET*/	YUYOPQJKZTVJGK = TIZIOJLJDPMOXB;
/*INC*/	if (!INC(YUYOPQJKZTVJGK, arg_to)) goto sentence_after_5;
	if (! isSymbolType(YUYOPQJKZTVJGK.container->type)) goto sentence_after_5;
/*SET*/	r_AA = YUYOPQJKZTVJGK;
//// [ &.name <any> ] 
/*DEF*/	DataCursor WXKEWPZHBJSUTH;
/*SET*/	WXKEWPZHBJSUTH = r_AA;
...
/*INC*/	if (!INC(SYOEFJGWWYEOZL, arg_to)) goto sentence_after_5;
...
/*DEF*/	DataCursor l_BB;
/*DEF*/	DataCursor r_BB;
/*SET*/	l_BB = SYOEFJGWWYEOZL;
/*SET*/	UHMGABBSQRHCRT = SYOEFJGWWYEOZL;
/*INC*/	if (!INC(UHMGABBSQRHCRT, arg_to)) goto sentence_after_5;
	if (! isSymbolType(UHMGABBSQRHCRT.container->type)) goto sentence_after_5;
/*SET*/	r_BB = UHMGABBSQRHCRT;
//// [ e.1 ] 
/*DEF*/	DataCursor l_e;
/*DEF*/	DataCursor r_e;
/*SET*/	l_e = r_BB;
...
QHTYDWPBSZXSBZ->append_copy(l_G, r_G, context); 
QHTYDWPBSZXSBZ->append_copy(l_G, r_G, context); 
QHTYDWPBSZXSBZ->append(newRefText("=")); 
QHTYDWPBSZXSBZ->append_copy(l_BB, r_BB, context); 
QHTYDWPBSZXSBZ->append_copy(l_e, r_e, context); 
...
/*DEF*/	DataCursor r_G;
/*SET*/	l_G = arg_from;
/*SET*/	IYRVGQMLUNWSCP = arg_from;
/*INC*/	if (!INC(IYRVGQMLUNWSCP, arg_to)) goto sentence_after_6;
	if (! isSymbolType(IYRVGQMLUNWSCP.container->type)) goto sentence_after_6;
/*SET*/	r_G = IYRVGQMLUNWSCP;
//// [ s.1 <any> ] 
/*DEF*/	DataCursor IRZFCBTSEPLKGW;
/*DEF*/	DataCursor l_s;
/*DEF*/	DataCursor r_s;
/*SET*/	l_s = r_G;
/*SET*/	IRZFCBTSEPLKGW = r_G;
/*INC*/	if (!INC(IRZFCBTSEPLKGW, arg_to)) goto sentence_after_6;
...
/*INC*/	if (!INC(FKHROUOYSRWMQO, arg_to)) goto sentence_after_6;
...
/*INC*/	if (!INC(PRSKWGXULSUCKB, arg_to)) goto sentence_after_6;
...
/*DEF*/	DataCursor l_BB;
/*DEF*/	DataCursor r_BB;
/*SET*/	l_BB = PRSKWGXULSUCKB;
/*SET*/	SEPJEISZSGCEZW = PRSKWGXULSUCKB;
/*INC*/	if (!INC(SEPJEISZSGCEZW, arg_to)) goto sentence_after_6;
	if (! isSymbolType(SEPJEISZSGCEZW.container->type)) goto sentence_after_6;
/*SET*/	r_BB = SEPJEISZSGCEZW;
//// [ e.1 ] 
/*DEF*/	DataCursor l_e;
/*DEF*/	DataCursor r_e;
/*SET*/	l_e = r_BB;
...
GZRIOQRQETKZFB->append_copy(l_G, r_G, context); 
GZRIOQRQETKZFB->append_copy(l_s, r_s, context); 
...
WYWMXXGDPYLRAX->append_copy(l_AA, r_AA, context); 
WYWMXXGDPYLRAX->append_copy(l_BB, r_BB, context); 
context->pushExecuteCall(WYWMXXGDPYLRAX_execbr);
context->pushExecuteCall(LDJIEMSFZBHZFN_execbr);
GZRIOQRQETKZFB->append_copy(l_e, r_e, context); 
...
GLMTBIYLBHCWHL->append_copy(l_e, r_e, context); 
...
/*SET*/	SYOYHGMGOPPRZA = arg_from;
/*INC*/	if (!INC(SYOYHGMGOPPRZA, arg_to)) goto sentence_after_1;
...
/*DEF*/	DataCursor l_A;
/*DEF*/	DataCursor r_A;
/*SET*/	l_A = SYOYHGMGOPPRZA;
/*SET*/	XQMOMSYHGAGIUP = SYOYHGMGOPPRZA;
/*INC*/	if (!INC(XQMOMSYHGAGIUP, arg_to)) goto sentence_after_1;
	if (! isSymbolType(XQMOMSYHGAGIUP.container->type)) goto sentence_after_1;
/*SET*/	r_A = XQMOMSYHGAGIUP;
//// [ s.1 <any> ] 
/*DEF*/	DataCursor JQBZXTHTOPOTMI;
/*DEF*/	DataCursor l_B;
/*DEF*/	DataCursor r_B;
/*SET*/	l_B = r_A;
/*SET*/	JQBZXTHTOPOTMI = r_A;
/*INC*/	if (!INC(JQBZXTHTOPOTMI, arg_to)) goto sentence_after_1;
	if (! isSymbolType(JQBZXTHTOPOTMI.container->type)) goto sentence_after_1;
/*SET*/	r_B = JQBZXTHTOPOTMI;
//// [ `a` <any> ] 
/*DEF*/	DataCursor TNQWTOETONXWZG;
/*SET*/	TNQWTOETONXWZG = r_B;
/*INC*/	if (!INC(TNQWTOETONXWZG, arg_to)) goto sentence_after_1;
	if (TNQWTOETONXWZG.container->type != text || *(TNQWTOETONXWZG.container->value.text + TNQWTOETONXWZG.index) != '-') goto sentence_after_1;
//// [ empty ] 
/*ISEMPTY*/	if (TNQWTOETONXWZG!=0 && arg_to != TNQWTOETONXWZG) goto sentence_after_1;

// подстановка 
context->prepareSubstitute(); 
result->append_copy(l_B, r_B, context); 
return result;
}
sentence_after_1: 
...
/*INC*/	if (!INC(TMSCKMAALKICSN, arg_to)) goto sentence_after_2;
...
/*DEF*/	DataCursor l_A;
/*DEF*/	DataCursor r_A;
/*SET*/	l_A = TMSCKMAALKICSN;
/*SET*/	XUCOVTYKRXAWZA = TMSCKMAALKICSN;
/*INC*/	if (!INC(XUCOVTYKRXAWZA, arg_to)) goto sentence_after_2;
	if (! isSymbolType(XUCOVTYKRXAWZA.container->type)) goto sentence_after_2;
/*SET*/	r_A = XUCOVTYKRXAWZA;
//// [ s.1 <any> ] 
/*DEF*/	DataCursor DJXWXQMNDHLDTT;
/*DEF*/	DataCursor l_B;
/*DEF*/	DataCursor r_B;
/*SET*/	l_B = r_A;
/*SET*/	DJXWXQMNDHLDTT = r_A;
/*INC*/	if (!INC(DJXWXQMNDHLDTT, arg_to)) goto sentence_after_2;
	if (! isSymbolType(DJXWXQMNDHLDTT.container->type)) goto sentence_after_2;
/*SET*/	r_B = DJXWXQMNDHLDTT;
//// [ `a` <any> ] 
/*DEF*/	DataCursor XSKNXTEZNJSQTF;
/*SET*/	XSKNXTEZNJSQTF = r_B;
/*INC*/	if (!INC(XSKNXTEZNJSQTF, arg_to)) goto sentence_after_2;
	if (XSKNXTEZNJSQTF.container->type != text || *(XSKNXTEZNJSQTF.container->value.text + XSKNXTEZNJSQTF.index) != '+') goto sentence_after_2;
//// [ empty ] 
/*ISEMPTY*/	if (XSKNXTEZNJSQTF!=0 && arg_to != XSKNXTEZNJSQTF) goto sentence_after_2;
...
/*INC*/	if (!INC(KWYWTTJZPPKWLB, arg_to)) goto sentence_after_3;
...
/*DEF*/	DataCursor l_B;
/*DEF*/	DataCursor r_B;
/*SET*/	l_B = KWYWTTJZPPKWLB;
/*SET*/	MJAHTPUTIEBPBB = KWYWTTJZPPKWLB;
/*INC*/	if (!INC(MJAHTPUTIEBPBB, arg_to)) goto sentence_after_3;
	if (! isSymbolType(MJAHTPUTIEBPBB.container->type)) goto sentence_after_3;
/*SET*/	r_B = MJAHTPUTIEBPBB;
//// [ s.1 <any> ] 
/*DEF*/	DataCursor MUEGYRHLTHXWGJ;
/*DEF*/	DataCursor l_A;
/*DEF*/	DataCursor r_A;
/*SET*/	l_A = r_B;
/*SET*/	MUEGYRHLTHXWGJ = r_B;
/*INC*/	if (!INC(MUEGYRHLTHXWGJ, arg_to)) goto sentence_after_3;
	if (! isSymbolType(MUEGYRHLTHXWGJ.container->type)) goto sentence_after_3;
/*SET*/	r_A = MUEGYRHLTHXWGJ;
//// [ `a` <any> ] 
/*DEF*/	DataCursor PRWVHSHZYAVQYE;
/*SET*/	PRWVHSHZYAVQYE = r_A;
/*INC*/	if (!INC(PRWVHSHZYAVQYE, arg_to)) goto sentence_after_3;
	if (PRWVHSHZYAVQYE.container->type != text || *(PRWVHSHZYAVQYE.container->value.text + PRWVHSHZYAVQYE.index) != '-') goto sentence_after_3;
//// [ empty ] 
/*ISEMPTY*/	if (PRWVHSHZYAVQYE!=0 && arg_to != PRWVHSHZYAVQYE) goto sentence_after_3;
...
/*INC*/	if (!INC(OIUOZXQTIHWAUR, arg_to)) goto sentence_after_4;
...
/*DEF*/	DataCursor l_B;
/*DEF*/	DataCursor r_B;
/*SET*/	l_B = OIUOZXQTIHWAUR;
/*SET*/	OQRDQWCVLXZIPO = OIUOZXQTIHWAUR;
/*INC*/	if (!INC(OQRDQWCVLXZIPO, arg_to)) goto sentence_after_4;
...
/*INC*/	if (!INC(DIISPQNZOMCWVA, arg_to)) goto sentence_after_4;
	if (! isSymbolType(DIISPQNZOMCWVA.container->type)) goto sentence_after_4;
/*SET*/	r_A = DIISPQNZOMCWVA;
//// [ `a` <any> ] 
/*DEF*/	DataCursor PTGRGDFNYYTKWW;
/*SET*/	PTGRGDFNYYTKWW = r_A;
/*INC*/	if (!INC(PTGRGDFNYYTKWW, arg_to)) goto sentence_after_4;
	if (PTGRGDFNYYTKWW.container->type != text || *(PTGRGDFNYYTKWW.container->value.text + PTGRGDFNYYTKWW.index) != '+') goto sentence_after_4;
//// [ empty ] 
/*ISEMPTY*/	if (PTGRGDFNYYTKWW!=0 && arg_to != PTGRGDFNYYTKWW) goto sentence_after_4;
...
/*SET*/	l_e = arg_from;
/*SET*/	r_e = arg_from;
/*JMP*/	goto label_GLFCIEBDUTOEUN_firststep;
...
/*DEF*/	DataCursor r_A;
/*SET*/	l_A = r_e;
/*SET*/	FHDAXPHBSYWZTP = r_e;
/*INC*/	if (!INC(FHDAXPHBSYWZTP, arg_to)) goto label_GLFCIEBDUTOEUN;
	if (! isSymbolType(FHDAXPHBSYWZTP.container->type)) goto label_GLFCIEBDUTOEUN;
/*SET*/	r_A = FHDAXPHBSYWZTP;
//// [ s.1 <any> ] 
/*DEF*/	DataCursor WJNGJNCPXRJVBV;
/*DEF*/	DataCursor l_zn;
/*DEF*/	DataCursor r_zn;
/*SET*/	l_zn = r_A;
/*SET*/	WJNGJNCPXRJVBV = r_A;
/*INC*/	if (!INC(WJNGJNCPXRJVBV, arg_to)) goto label_GLFCIEBDUTOEUN;
	if (! isSymbolType(WJNGJNCPXRJVBV.container->type)) goto label_GLFCIEBDUTOEUN;
/*SET*/	r_zn = WJNGJNCPXRJVBV;
//// [ empty ] 
/*ISEMPTY*/	if (r_zn!=0 && arg_to != r_zn) goto label_GLFCIEBDUTOEUN;
...
/*SET*/	CCEFKBEMGSDYMZ = arg_from;
/*INC*/	if (!INC(CCEFKBEMGSDYMZ, arg_to)) goto sentence_after_2;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_g;
/*DEF*/	DataCursor r_g;
/*SET*/	l_g = MMKWDEHFKRUQBY;
/*SET*/	UBRYYESHQLZMRE = MMKWDEHFKRUQBY;
/*INC*/	if (!INC(UBRYYESHQLZMRE, VECMPESROMDXLL)) goto sentence_after_2;
	if (! isSymbolType(UBRYYESHQLZMRE.container->type)) goto sentence_after_2;
/*SET*/	r_g = UBRYYESHQLZMRE;
//// [ empty ] 
/*ISEMPTY*/	if (r_g!=0 && VECMPESROMDXLL != r_g) goto sentence_after_2;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor WQNKQITXGIIGQU;
/*DEF*/	DataCursor SKWTCZNLTERXBL;
/*DEF*/	DataCursor TZYDYZVAHNKIXJ;
/*SET*/	WQNKQITXGIIGQU = CCEFKBEMGSDYMZ;
/*INC*/	if (!INC(WQNKQITXGIIGQU, arg_to)) goto sentence_after_2;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_1;
/*DEF*/	DataCursor r_1;
/*SET*/	l_1 = SKWTCZNLTERXBL;
/*SET*/	r_1 = TZYDYZVAHNKIXJ;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor WZZTDJPQSUOWKV;
/*DEF*/	DataCursor FCCOCKVRJBFRJP;
/*DEF*/	DataCursor CGDJDRWDNPOSRJ;
/*SET*/	WZZTDJPQSUOWKV = WQNKQITXGIIGQU;
/*INC*/	if (!INC(WZZTDJPQSUOWKV, arg_to)) goto sentence_after_2;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_2;
/*DEF*/	DataCursor r_2;
/*SET*/	l_2 = FCCOCKVRJBFRJP;
/*SET*/	r_2 = CGDJDRWDNPOSRJ;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor GDRQRVQTVPPAZH;
/*DEF*/	DataCursor LTJQVCCLPEZTSJ;
/*DEF*/	DataCursor PYNZFROTQPOXMW;
/*SET*/	GDRQRVQTVPPAZH = WZZTDJPQSUOWKV;
/*INC*/	if (!INC(GDRQRVQTVPPAZH, arg_to)) goto sentence_after_2;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_n;
/*DEF*/	DataCursor r_n;
/*SET*/	l_n = LTJQVCCLPEZTSJ;
/*SET*/	r_n = PYNZFROTQPOXMW;
//// [ empty ] 
/*ISEMPTY*/	if (GDRQRVQTVPPAZH!=0 && arg_to != GDRQRVQTVPPAZH) goto sentence_after_2;
...
IFIFRTWQQEOJUE->append_copy(l_g, r_g, context); 
...
JURSQGSCZVHHUJ->append_copy(l_1, r_1, context); 
...
UWZKCTKAGXKSMF->append_copy(l_2, r_2, context); 
...
HWMHLVBYPECJEI->append_copy(l_n, r_n, context); 
...
/*SET*/	BLHWBAFBGARCSF = arg_from;
/*INC*/	if (!INC(BLHWBAFBGARCSF, arg_to)) goto sentence_after_1;
//// ISBRACKET 
...
/*SET*/	FCOMVNTMDHZXLE = IJYLBIIMOFGXEI;
/*INC*/	if (!INC(FCOMVNTMDHZXLE, RPBTYWQZAPKKCA)) goto sentence_after_1;
	if (FCOMVNTMDHZXLE.container->type != text || *(FCOMVNTMDHZXLE.container->value.text + FCOMVNTMDHZXLE.index) != '1') goto sentence_after_1;
//// [ empty ] 
/*ISEMPTY*/	if (FCOMVNTMDHZXLE!=0 && RPBTYWQZAPKKCA != FCOMVNTMDHZXLE) goto sentence_after_1;
//// [ e.1 <any> ] 
/*DEF*/	DataCursor l_eee1;
/*DEF*/	DataCursor r_eee1;
/*SET*/	l_eee1 = BLHWBAFBGARCSF;
/*SET*/	r_eee1 = BLHWBAFBGARCSF;
/*JMP*/	goto label_YCWMFYAQQIANNY_firststep;
...
/*SET*/	HQOUIZVEAVGZJW = r_eee1;
/*INC*/	if (!INC(HQOUIZVEAVGZJW, arg_to)) goto label_YCWMFYAQQIANNY;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_1;
/*DEF*/	DataCursor r_1;
/*SET*/	l_1 = OBLSGWNKVJLNIV;
/*SET*/	r_1 = OBLSGWNKVJLNIV;
/*JMP*/	goto label_XQKWWMTFISGGLG_firststep;
label_XQKWWMTFISGGLG: 
/*INC*/	if (!INC(r_1, QCWVZXTCTHYNMU)) goto label_YCWMFYAQQIANNY;
...
/*DEF*/	DataCursor r_A;
/*SET*/	l_A = r_1;
/*SET*/	COXPIPYTDBAMRY = r_1;
/*INC*/	if (!INC(COXPIPYTDBAMRY, QCWVZXTCTHYNMU)) goto label_XQKWWMTFISGGLG;
...
/*SET*/	l_2 = r_A;
/*SET*/	r_2 = r_A;
/*JMP*/	goto label_KBOKMWGSDDPQKR_firststep;
label_KBOKMWGSDDPQKR: 
/*INC*/	if (!INC(r_2, QCWVZXTCTHYNMU)) goto label_XQKWWMTFISGGLG;
label_KBOKMWGSDDPQKR_firststep: 
//// [ &.name <any> ] 
/*DEF*/	DataCursor ZYJCHZTMIEPAGW;
/*SET*/	ZYJCHZTMIEPAGW = r_2;
 if (!SLIDE(ZYJCHZTMIEPAGW, QCWVZXTCTHYNMU, l_A, r_A)) goto label_KBOKMWGSDDPQKR;
//// [ e.1 ] 
/*DEF*/	DataCursor l_3;
/*DEF*/	DataCursor r_3;
/*SET*/	l_3 = ZYJCHZTMIEPAGW;
/*SET*/	r_3 = QCWVZXTCTHYNMU;
//// [ e.1 <any> ] 
/*DEF*/	DataCursor l_eee2;
/*DEF*/	DataCursor r_eee2;
/*SET*/	l_eee2 = HQOUIZVEAVGZJW;
/*SET*/	r_eee2 = HQOUIZVEAVGZJW;
/*JMP*/	goto label_HROQKHWUDBCIHP_firststep;
label_HROQKHWUDBCIHP: 
/*INC*/	if (!INC(r_eee2, arg_to)) goto label_KBOKMWGSDDPQKR;
label_HROQKHWUDBCIHP_firststep: 
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor QWAQZXUGKVAKVL;
/*DEF*/	DataCursor AVKSWFZSDBVQID;
/*DEF*/	DataCursor HTBCDEYTMPPHKU;
/*SET*/	QWAQZXUGKVAKVL = r_eee2;
/*INC*/	if (!INC(QWAQZXUGKVAKVL, arg_to)) goto label_HROQKHWUDBCIHP;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_n1;
/*DEF*/	DataCursor r_n1;
/*SET*/	l_n1 = AVKSWFZSDBVQID;
/*SET*/	r_n1 = AVKSWFZSDBVQID;
/*JMP*/	goto label_HSXORPUFWHJRUT_firststep;
label_HSXORPUFWHJRUT: 
/*INC*/	if (!INC(r_n1, HTBCDEYTMPPHKU)) goto label_HROQKHWUDBCIHP;
label_HSXORPUFWHJRUT_firststep: 
//// [ &.name <any> ] 
/*DEF*/	DataCursor KSSLHLRXLYDXVK;
/*SET*/	KSSLHLRXLYDXVK = r_n1;
 if (!SLIDE(KSSLHLRXLYDXVK, HTBCDEYTMPPHKU, l_A, r_A)) goto label_HSXORPUFWHJRUT;
//// [ e.1 ] 
/*DEF*/	DataCursor l_n2;
/*DEF*/	DataCursor r_n2;
/*SET*/	l_n2 = KSSLHLRXLYDXVK;
/*SET*/	r_n2 = HTBCDEYTMPPHKU;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor OSAGGMPBGZVBAF;
/*DEF*/	DataCursor AZJOHQSSWTORCK;
/*DEF*/	DataCursor QAXSREHNRLYJIW;
/*SET*/	OSAGGMPBGZVBAF = QWAQZXUGKVAKVL;
/*INC*/	if (!INC(OSAGGMPBGZVBAF, arg_to)) goto label_HSXORPUFWHJRUT;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_e1;
/*DEF*/	DataCursor r_e1;
/*SET*/	l_e1 = AZJOHQSSWTORCK;
/*SET*/	r_e1 = QAXSREHNRLYJIW;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor TMHGLKOZFKMMXT;
/*DEF*/	DataCursor YVOXHFKXOPVYBJ;
/*DEF*/	DataCursor ZOXHZUBDNTOAMZ;
/*SET*/	TMHGLKOZFKMMXT = OSAGGMPBGZVBAF;
/*INC*/	if (!INC(TMHGLKOZFKMMXT, arg_to)) goto label_HSXORPUFWHJRUT;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_e2;
/*DEF*/	DataCursor r_e2;
/*SET*/	l_e2 = YVOXHFKXOPVYBJ;
/*SET*/	r_e2 = ZOXHZUBDNTOAMZ;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor OTTCJTUEGMPQKC;
/*DEF*/	DataCursor DBBGCKJQTEBICH;
/*DEF*/	DataCursor ZNPPRQISWBDHOY;
/*SET*/	OTTCJTUEGMPQKC = TMHGLKOZFKMMXT;
/*INC*/	if (!INC(OTTCJTUEGMPQKC, arg_to)) goto label_HSXORPUFWHJRUT;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_n;
/*DEF*/	DataCursor r_n;
/*SET*/	l_n = DBBGCKJQTEBICH;
/*SET*/	r_n = ZNPPRQISWBDHOY;
//// [ empty ] 
/*ISEMPTY*/	if (OTTCJTUEGMPQKC!=0 && arg_to != OTTCJTUEGMPQKC) goto label_HSXORPUFWHJRUT;
...
FWXWDRNLFFBFHV->append_copy(l_n, r_n, context); 
...
YXZUKJWOCYHZQJ->append_copy(l_A, r_A, context); 
...
/*SET*/	ZDHTBRRRLLKTCH = arg_from;
/*INC*/	if (!INC(ZDHTBRRRLLKTCH, arg_to)) goto sentence_after_2;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_g;
/*DEF*/	DataCursor r_g;
/*SET*/	l_g = FNCTPIRNAWONYD;
/*SET*/	HQODEMAKMUNMAX = FNCTPIRNAWONYD;
/*INC*/	if (!INC(HQODEMAKMUNMAX, WWVUABUQCIMCNL)) goto sentence_after_2;
	if (! isSymbolType(HQODEMAKMUNMAX.container->type)) goto sentence_after_2;
/*SET*/	r_g = HQODEMAKMUNMAX;
//// [ empty ] 
/*ISEMPTY*/	if (r_g!=0 && WWVUABUQCIMCNL != r_g) goto sentence_after_2;
//// [ e.1 <any> ] 
/*DEF*/	DataCursor l_e;
/*DEF*/	DataCursor r_e;
/*SET*/	l_e = ZDHTBRRRLLKTCH;
/*SET*/	r_e = ZDHTBRRRLLKTCH;
/*JMP*/	goto label_IOMKEYWCOFQBKD_firststep;
...
/*SET*/	MZOIZGQIPZAYIX = r_e;
/*INC*/	if (!INC(MZOIZGQIPZAYIX, arg_to)) goto label_IOMKEYWCOFQBKD;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_1;
/*DEF*/	DataCursor r_1;
/*SET*/	l_1 = RYDWSOVHZTKGZS;
/*SET*/	r_1 = KWPTKQCEXRNNXS;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor KYWNDQIZLZKLNI;
/*DEF*/	DataCursor SSAMQAZHLNDNVI;
/*DEF*/	DataCursor LTKOIAFMEICGGU;
/*SET*/	KYWNDQIZLZKLNI = MZOIZGQIPZAYIX;
/*INC*/	if (!INC(KYWNDQIZLZKLNI, arg_to)) goto label_IOMKEYWCOFQBKD;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_n;
/*DEF*/	DataCursor r_n;
/*SET*/	l_n = AVNVSLONOASRUD;
/*SET*/	r_n = RNLDKLDKFZTAGI;
//// [ empty ] 
/*ISEMPTY*/	if (ZXHRDJZZHERUSW!=0 && arg_to != ZXHRDJZZHERUSW) goto label_IOMKEYWCOFQBKD;
...
/*SET*/	IXZTWDYRUUMQAD = arg_from;
/*INC*/	if (!INC(IXZTWDYRUUMQAD, arg_to)) goto sentence_after_1;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_n1;
/*DEF*/	DataCursor r_n1;
/*SET*/	l_n1 = JEPVVCVOIDWMTP;
/*SET*/	r_n1 = JEPVVCVOIDWMTP;
/*JMP*/	goto label_ZDAPDZGHAVVIYI_firststep;
label_ZDAPDZGHAVVIYI: 
/*INC*/	if (!INC(r_n1, BNMQUIOPIWPUWC)) goto sentence_after_1;
...
/*SET*/	KEFUTXXIBHPULN = arg_from;
/*INC*/	if (!INC(KEFUTXXIBHPULN, arg_to)) goto sentence_after_1;
	if (KEFUTXXIBHPULN.container->type != text || *(KEFUTXXIBHPULN.container->value.text + KEFUTXXIBHPULN.index) != '1') goto sentence_after_1;
//// [ empty ] 
/*ISEMPTY*/	if (KEFUTXXIBHPULN!=0 && arg_to != KEFUTXXIBHPULN) goto sentence_after_1;
...
/*SET*/	WAPBHLPUDOEMNN = arg_from;
/*INC*/	if (!INC(WAPBHLPUDOEMNN, arg_to)) goto sentence_after_2;
	if (WAPBHLPUDOEMNN.container->type != text || *(WAPBHLPUDOEMNN.container->value.text + WAPBHLPUDOEMNN.index) != '2') goto sentence_after_2;
//// [ empty ] 
/*ISEMPTY*/	if (WAPBHLPUDOEMNN!=0 && arg_to != WAPBHLPUDOEMNN) goto sentence_after_2;
...
/*SET*/	PLTTRIABWUCRJM = arg_from;
/*INC*/	if (!INC(PLTTRIABWUCRJM, arg_to)) goto sentence_after_3;
	if (PLTTRIABWUCRJM.container->type != text || *(PLTTRIABWUCRJM.container->value.text + PLTTRIABWUCRJM.index) != '3') goto sentence_after_3;
//// [ empty ] 
/*ISEMPTY*/	if (PLTTRIABWUCRJM!=0 && arg_to != PLTTRIABWUCRJM) goto sentence_after_3;
...
/*SET*/	QSQCHLHTBOFUIK = arg_from;
/*INC*/	if (!INC(QSQCHLHTBOFUIK, arg_to)) goto sentence_after_4;
	if (QSQCHLHTBOFUIK.container->type != text || *(QSQCHLHTBOFUIK.container->value.text + QSQCHLHTBOFUIK.index) != '4') goto sentence_after_4;
//// [ empty ] 
/*ISEMPTY*/	if (QSQCHLHTBOFUIK!=0 && arg_to != QSQCHLHTBOFUIK) goto sentence_after_4;
...
/*SET*/	KDEYHOKQUWQVWT = arg_from;
/*INC*/	if (!INC(KDEYHOKQUWQVWT, arg_to)) goto sentence_after_5;
	if (KDEYHOKQUWQVWT.container->type != text || *(KDEYHOKQUWQVWT.container->value.text + KDEYHOKQUWQVWT.index) != '5') goto sentence_after_5;
//// [ empty ] 
/*ISEMPTY*/	if (KDEYHOKQUWQVWT!=0 && arg_to != KDEYHOKQUWQVWT) goto sentence_after_5;
...
/*SET*/	IPBNCIZOCKAADA = arg_from;
/*INC*/	if (!INC(IPBNCIZOCKAADA, arg_to)) goto sentence_after_6;
	if (IPBNCIZOCKAADA.container->type != text || *(IPBNCIZOCKAADA.container->value.text + IPBNCIZOCKAADA.index) != '6') goto sentence_after_6;
//// [ empty ] 
/*ISEMPTY*/	if (IPBNCIZOCKAADA!=0 && arg_to != IPBNCIZOCKAADA) goto sentence_after_6;
...
/*SET*/	RZLSRWXOCCSLUT = arg_from;
/*INC*/	if (!INC(RZLSRWXOCCSLUT, arg_to)) goto sentence_after_7;
	if (RZLSRWXOCCSLUT.container->type != text || *(RZLSRWXOCCSLUT.container->value.text + RZLSRWXOCCSLUT.index) != '7') goto sentence_after_7;
//// [ empty ] 
/*ISEMPTY*/	if (RZLSRWXOCCSLUT!=0 && arg_to != RZLSRWXOCCSLUT) goto sentence_after_7;
...
/*INC*/	if (!INC(LRLUKDIAOHQJHR, arg_to)) goto sentence_after_8;
	if (LRLUKDIAOHQJHR.container->type != text || *(LRLUKDIAOHQJHR.container->value.text + LRLUKDIAOHQJHR.index) != '8') goto sentence_after_8;
//// [ empty ] 
/*ISEMPTY*/	if (LRLUKDIAOHQJHR!=0 && arg_to != LRLUKDIAOHQJHR) goto sentence_after_8;
...
/*SET*/	FNHCBKPMESUPMT = r_eee;
/*INC*/	if (!INC(FNHCBKPMESUPMT, arg_to)) goto label_DRXJSTCWRSXGYW;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_3;
/*DEF*/	DataCursor r_3;
/*SET*/	l_3 = RVIPFBKTBWZFAH;
/*SET*/	r_3 = RVIPFBKTBWZFAH;
/*JMP*/	goto label_YWCVHKTDOXQTEK_firststep;
label_YWCVHKTDOXQTEK: 
/*INC*/	if (!INC(r_3, OEVNHXBRHHFOBG)) goto label_DRXJSTCWRSXGYW;
label_YWCVHKTDOXQTEK_firststep: 
//// [ `a` <any> ] 
/*DEF*/	DataCursor IWWURZBLMLDLFI;
/*SET*/	IWWURZBLMLDLFI = r_3;
/*INC*/	if (!INC(IWWURZBLMLDLFI, OEVNHXBRHHFOBG)) goto label_YWCVHKTDOXQTEK;
	if (IWWURZBLMLDLFI.container->type != text || *(IWWURZBLMLDLFI.container->value.text + IWWURZBLMLDLFI.index) != '>') goto label_YWCVHKTDOXQTEK;
//// [ empty ] 
/*ISEMPTY*/	if (IWWURZBLMLDLFI!=0 && OEVNHXBRHHFOBG != IWWURZBLMLDLFI) goto label_YWCVHKTDOXQTEK;
//// [ empty ] 
/*ISEMPTY*/	if (FNHCBKPMESUPMT!=0 && arg_to != FNHCBKPMESUPMT) goto label_YWCVHKTDOXQTEK;
...
/*SET*/	VVRGKTRERPTISI = arg_from;
/*INC*/	if (!INC(VVRGKTRERPTISI, arg_to)) goto sentence_after_3;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_g;
/*DEF*/	DataCursor r_g;
/*SET*/	l_g = ZXHREVNXQUEZXK;
/*SET*/	HTJHYEZKYHPFXW = ZXHREVNXQUEZXK;
/*INC*/	if (!INC(HTJHYEZKYHPFXW, UGROOHRHUDIDGV)) goto sentence_after_3;
	if (! isSymbolType(HTJHYEZKYHPFXW.container->type)) goto sentence_after_3;
/*SET*/	r_g = HTJHYEZKYHPFXW;
//// [ empty ] 
/*ISEMPTY*/	if (r_g!=0 && UGROOHRHUDIDGV != r_g) goto sentence_after_3;
//// [ e.1 <any> ] 
/*DEF*/	DataCursor l_eee;
/*DEF*/	DataCursor r_eee;
/*SET*/	l_eee = VVRGKTRERPTISI;
/*SET*/	r_eee = VVRGKTRERPTISI;
/*JMP*/	goto label_GPRPSEACCXKWVI_firststep;
...
/*SET*/	XVFHQFAWKFDJPY = r_eee;
/*INC*/	if (!INC(XVFHQFAWKFDJPY, arg_to)) goto label_GPRPSEACCXKWVI;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_3;
/*DEF*/	DataCursor r_3;
/*SET*/	l_3 = EEVDGGATFIEKIX;
/*SET*/	r_3 = EEVDGGATFIEKIX;
/*JMP*/	goto label_QMYHJMJTIMDSPI_firststep;
label_QMYHJMJTIMDSPI: 
/*INC*/	if (!INC(r_3, EYRFCPXSCJKCFG)) goto label_GPRPSEACCXKWVI;
label_QMYHJMJTIMDSPI_firststep: 
//// [ `a` <any> ] 
/*DEF*/	DataCursor ZHWZIZCYUCEGLM;
/*SET*/	ZHWZIZCYUCEGLM = r_3;
/*INC*/	if (!INC(ZHWZIZCYUCEGLM, EYRFCPXSCJKCFG)) goto label_QMYHJMJTIMDSPI;
...
/*DEF*/	DataCursor l_s;
/*DEF*/	DataCursor r_s;
/*SET*/	l_s = ZHWZIZCYUCEGLM;
/*SET*/	MBGYGFVTQVZQAT = ZHWZIZCYUCEGLM;
/*INC*/	if (!INC(MBGYGFVTQVZQAT, EYRFCPXSCJKCFG)) goto label_QMYHJMJTIMDSPI;
	if (! isSymbolType(MBGYGFVTQVZQAT.container->type)) goto label_QMYHJMJTIMDSPI;
/*SET*/	r_s = MBGYGFVTQVZQAT;
//// [ e.1 ] 
/*DEF*/	DataCursor l_4;
/*DEF*/	DataCursor r_4;
/*SET*/	l_4 = r_s;
/*SET*/	r_4 = EYRFCPXSCJKCFG;
//// [ empty ] 
/*ISEMPTY*/	if (XVFHQFAWKFDJPY!=0 && arg_to != XVFHQFAWKFDJPY) goto label_QMYHJMJTIMDSPI;
...
UMJCAFCUYVDCUE->append_copy(l_g, r_g, context); 
BPMBLXNKEOFMNI->append_copy(l_eee, r_eee, context); 
DataChain* TERQPJJWAKNKXT = new DataChain(); 
BPMBLXNKEOFMNI->append(newRefStructBrackets(TERQPJJWAKNKXT)); 
TERQPJJWAKNKXT->append_copy(l_3, r_3, context); 
TERQPJJWAKNKXT->append(newRefText(">")); 
TERQPJJWAKNKXT->append_copy(l_s, r_s, context); 
TERQPJJWAKNKXT->append_copy(l_4, r_4, context); 
...
LNUKBIYSPLKHJU->append_copy(l_g, r_g, context); 
LZQFLJNWKXGKFY->append_copy(l_eee, r_eee, context); 
DataChain* CFUWOHZVPHJBJY = new DataChain(); 
LZQFLJNWKXGKFY->append(newRefStructBrackets(CFUWOHZVPHJBJY)); 
CFUWOHZVPHJBJY->append_copy(l_3, r_3, context); 
CFUWOHZVPHJBJY->append_copy(l_s, r_s, context); 
CFUWOHZVPHJBJY->append(newRefText(">")); 
CFUWOHZVPHJBJY->append_copy(l_4, r_4, context); 
...
/*DEF*/	DataCursor r_1;
/*SET*/	l_1 = arg_from;
/*SET*/	OVDLNBFRKVBEMW = arg_from;
/*INC*/	if (!INC(OVDLNBFRKVBEMW, arg_to)) goto sentence_after_1;
	if (! isSymbolType(OVDLNBFRKVBEMW.container->type)) goto sentence_after_1;
/*SET*/	r_1 = OVDLNBFRKVBEMW;
//// [ e.1 ] 
/*DEF*/	DataCursor l_2;
/*DEF*/	DataCursor r_2;
/*SET*/	l_2 = r_1;
...
/*SET*/	l_1 = arg_from;
/*SET*/	r_1 = arg_from;
/*JMP*/	goto label_YTFJYNQMGZAGBK_firststep;
...
/*SET*/	WEKKOUXDCYNKHT = r_1;
/*INC*/	if (!INC(WEKKOUXDCYNKHT, arg_to)) goto label_YTFJYNQMGZAGBK;
...
PJIKVPAUDVKXGL->append_copy(l_1, r_1, context); 
...
KDORJFNYGHHHPT->append_copy(l_2, r_2, context); 
...
/*SET*/	l_1 = arg_from;
/*SET*/	r_1 = arg_from;
/*JMP*/	goto label_OWDZSFQHKPLFBY_firststep;
...
/*SET*/	ZMNIMDLXMJYDAX = r_1;
/*INC*/	if (!INC(ZMNIMDLXMJYDAX, arg_to)) goto label_OWDZSFQHKPLFBY;
...
OQFOTPIKPQUDMO->append_copy(l_1, r_1, context); 
...
/*DEF*/	DataCursor r_1;
/*SET*/	l_1 = arg_from;
/*SET*/	MIKPPZHDHFQSGB = arg_from;
/*INC*/	if (!INC(MIKPPZHDHFQSGB, arg_to)) goto sentence_after_1;
	if (! isSymbolType(MIKPPZHDHFQSGB.container->type)) goto sentence_after_1;
/*SET*/	r_1 = MIKPPZHDHFQSGB;
//// [ s.1 <any> ] 
/*DEF*/	DataCursor XIISYZWNHXYFVY;
/*DEF*/	DataCursor l_2;
/*DEF*/	DataCursor r_2;
/*SET*/	l_2 = r_1;
/*SET*/	XIISYZWNHXYFVY = r_1;
/*INC*/	if (!INC(XIISYZWNHXYFVY, arg_to)) goto sentence_after_1;
	if (! isSymbolType(XIISYZWNHXYFVY.container->type)) goto sentence_after_1;
/*SET*/	r_2 = XIISYZWNHXYFVY;
//// [ empty ] 
...
YNDGCNFJITPPMY->append_copy(l_1, r_1, context); 
YNDGCNFJITPPMY->append_copy(l_2, r_2, context); 
context->pushExecuteCall(YNDGCNFJITPPMY_execbr);
DFMPDWOMCIUDCN->append_copy(l_1, r_1, context); 
DFMPDWOMCIUDCN->append_copy(l_2, r_2, context); 
...
/*DEF*/	DataCursor l_1;
/*DEF*/	DataCursor r_1;
/*SET*/	l_1 = MXIISNEBPYWSGQ;
/*SET*/	SXDJPLWZFMJOOP = MXIISNEBPYWSGQ;
/*INC*/	if (!INC(SXDJPLWZFMJOOP, arg_to)) goto sentence_after_1;
	if (! isSymbolType(SXDJPLWZFMJOOP.container->type)) goto sentence_after_1;
/*SET*/	r_1 = SXDJPLWZFMJOOP;
//// [ s.1 <any> ] 
/*DEF*/	DataCursor YYIFVKMWWPGPLJ;
/*DEF*/	DataCursor l_2;
/*DEF*/	DataCursor r_2;
/*SET*/	l_2 = r_1;
/*SET*/	YYIFVKMWWPGPLJ = r_1;
/*INC*/	if (!INC(YYIFVKMWWPGPLJ, arg_to)) goto sentence_after_1;
	if (! isSymbolType(YYIFVKMWWPGPLJ.container->type)) goto sentence_after_1;
/*SET*/	r_2 = YYIFVKMWWPGPLJ;
//// [ empty ] 
/*ISEMPTY*/	if (r_2!=0 && arg_to != r_2) goto sentence_after_1;
...
FBRWHPEVCOQRGR->append_copy(l_1, r_1, context); 
FBRWHPEVCOQRGR->append_copy(l_2, r_2, context); 
...
/*INC*/	if (!INC(QWZHIBNORKHZML, arg_to)) goto sentence_after_2;
	if (! isSymbolType(QWZHIBNORKHZML.container->type)) goto sentence_after_2;
/*SET*/	r_zn = QWZHIBNORKHZML;
//// [ s.1 <any> ] 
/*DEF*/	DataCursor BZFHXUNRKLIBVP;
/*DEF*/	DataCursor l_1;
/*DEF*/	DataCursor r_1;
/*SET*/	l_1 = r_zn;
/*SET*/	BZFHXUNRKLIBVP = r_zn;
/*INC*/	if (!INC(BZFHXUNRKLIBVP, arg_to)) goto sentence_after_2;
	if (! isSymbolType(BZFHXUNRKLIBVP.container->type)) goto sentence_after_2;
/*SET*/	r_1 = BZFHXUNRKLIBVP;
//// [ s.1 <any> ] 
/*DEF*/	DataCursor SZZNOPFGAXZGFL;
/*DEF*/	DataCursor l_2;
/*DEF*/	DataCursor r_2;
/*SET*/	l_2 = r_1;
/*SET*/	SZZNOPFGAXZGFL = r_1;
/*INC*/	if (!INC(SZZNOPFGAXZGFL, arg_to)) goto sentence_after_2;
	if (! isSymbolType(SZZNOPFGAXZGFL.container->type)) goto sentence_after_2;
/*SET*/	r_2 = SZZNOPFGAXZGFL;
//// [ empty ] 
...
TLSXBTUMILOCLT->append_copy(l_2, r_2, context); 
TLSXBTUMILOCLT->append_copy(l_1, r_1, context); 
...
/*SET*/	GCOZGTZIUFUZIM = arg_from;
/*INC*/	if (!INC(GCOZGTZIUFUZIM, arg_to)) goto sentence_after_1;
	if (GCOZGTZIUFUZIM.container->type != text || *(GCOZGTZIUFUZIM.container->value.text + GCOZGTZIUFUZIM.index) != '1') goto sentence_after_1;
//// [ empty ] 
/*ISEMPTY*/	if (GCOZGTZIUFUZIM!=0 && arg_to != GCOZGTZIUFUZIM) goto sentence_after_1;
...
/*SET*/	DIOGCSEOZPSCRH = arg_from;
/*INC*/	if (!INC(DIOGCSEOZPSCRH, arg_to)) goto sentence_after_2;
	if (DIOGCSEOZPSCRH.container->type != text || *(DIOGCSEOZPSCRH.container->value.text + DIOGCSEOZPSCRH.index) != '2') goto sentence_after_2;
//// [ empty ] 
/*ISEMPTY*/	if (DIOGCSEOZPSCRH!=0 && arg_to != DIOGCSEOZPSCRH) goto sentence_after_2;
...
SVUBPYLONMWAJG->append_copy(l_e, r_e, context); 
...
XZGYZAOVENFVOC->append_copy(l_e, r_e, context); 
...
UDNVQZBKATNEFU->append_copy(l_1, r_1, context); 
UDNVQZBKATNEFU->append_copy(l_3, r_3, context); 
...
/*SET*/	l_1 = arg_from;
/*SET*/	r_1 = arg_from;
/*JMP*/	goto label_LGEXKTRMHDDAPS_firststep;
label_LGEXKTRMHDDAPS: 
/*INC*/	if (!INC(r_1, arg_to)) goto sentence_after_2;
label_LGEXKTRMHDDAPS_firststep: 
//// [ `a` <any> ] 
/*DEF*/	DataCursor WPTFVOVUJIUWBM;
/*SET*/	WPTFVOVUJIUWBM = r_1;
/*INC*/	if (!INC(WPTFVOVUJIUWBM, arg_to)) goto label_LGEXKTRMHDDAPS;
...
CHJWZWMOZECRZN->append_copy(l_1, r_1, context); 
CHJWZWMOZECRZN->append_copy(l_2, r_2, context); 
...
/*SET*/	l_1 = arg_from;
/*SET*/	r_1 = arg_from;
/*JMP*/	goto label_JKFRVKRMRDWROA_firststep;
label_JKFRVKRMRDWROA: 
/*INC*/	if (!INC(r_1, arg_to)) goto sentence_after_2;
label_JKFRVKRMRDWROA_firststep: 
//// [ `a` <any> ] 
/*DEF*/	DataCursor OCQPKTLMWXWTNU;
/*SET*/	OCQPKTLMWXWTNU = r_1;
/*INC*/	if (!INC(OCQPKTLMWXWTNU, arg_to)) goto label_JKFRVKRMRDWROA;
...
NHIIULLTOVBEFL->append_copy(l_1, r_1, context); 
NHIIULLTOVBEFL->append_copy(l_2, r_2, context); 
...
/*SET*/	l_1 = arg_from;
/*SET*/	r_1 = arg_from;
/*JMP*/	goto label_WLPBHYFFHBAVHF_firststep;
...
/*INC*/	if (!INC(UAHLINDJDFPEKX, arg_to)) goto label_WLPBHYFFHBAVHF;
...
VWXKYVULCYJEFL->append_copy(l_1, r_1, context); 
VWXKYVULCYJEFL->append_copy(l_2, r_2, context); 
...
VEGHMFBMVKLSQF->append_copy(l_1, r_1, context); 
VEGHMFBMVKLSQF->append_copy(l_2, r_2, context); 
...
/*SET*/	l_1 = arg_from;
/*SET*/	r_1 = arg_from;
/*JMP*/	goto label_UBVXCTEPVMLJOH_firststep;
...
/*SET*/	ZXXOOLNVLAYGUO = r_1;
/*INC*/	if (!INC(ZXXOOLNVLAYGUO, arg_to)) goto label_UBVXCTEPVMLJOH;
...
KQTAXJLRBRUKKK->append_copy(l_2, r_2, context); 
...
/*SET*/	l_1 = arg_from;
/*SET*/	r_1 = arg_from;
/*JMP*/	goto label_IGJMXQRBAZLPDE_firststep;
label_IGJMXQRBAZLPDE: 
/*INC*/	if (!INC(r_1, arg_to)) goto sentence_after_6;
label_IGJMXQRBAZLPDE_firststep: 
//// [ `a` <any> ] 
/*DEF*/	DataCursor VPEZPBWSHVPCKL;
/*SET*/	VPEZPBWSHVPCKL = r_1;
/*INC*/	if (!INC(VPEZPBWSHVPCKL, arg_to)) goto label_IGJMXQRBAZLPDE;
...
QUYXPIXQIREUQA->append_copy(l_1, r_1, context); 
QUYXPIXQIREUQA->append_copy(l_2, r_2, context); 
...
BKUREHRQBBXAJE->append_copy(l_1, r_1, context); 
...
TSGRZUIGUSNWLY->append_copy(l_1, r_1, context); 
TSGRZUIGUSNWLY->append_copy(l_2, r_2, context); 
...
BKDBMVHBSNJBTV->append_copy(l_1, r_1, context); 
BKDBMVHBSNJBTV->append_copy(l_2, r_2, context); 
...
/*SET*/	l_1 = arg_from;
/*SET*/	r_1 = arg_from;
/*JMP*/	goto label_JTQNBCHIWFUQLZ_firststep;
label_JTQNBCHIWFUQLZ: 
/*INC*/	if (!INC(r_1, arg_to)) goto sentence_after_10;
label_JTQNBCHIWFUQLZ_firststep: 
//// [ `a` <any> ] 
/*DEF*/	DataCursor SMXVFJTVQUITIV;
/*SET*/	SMXVFJTVQUITIV = r_1;
/*INC*/	if (!INC(SMXVFJTVQUITIV, arg_to)) goto label_JTQNBCHIWFUQLZ;
...
CANCHXSSJLUHLY->append_copy(l_2, r_2, context); 
...
/*DEF*/	DataCursor l_1;
/*DEF*/	DataCursor r_1;
/*SET*/	l_1 = LIUEJOBCFPVNYR;
/*SET*/	r_1 = RPKEGEQPVLHXEE;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor OCMERJMZIUDTSQ;
/*DEF*/	DataCursor QOZVEJNRTIBVNJ;
/*DEF*/	DataCursor EPFQDSMVSTMMWW;
/*SET*/	OCMERJMZIUDTSQ = OEBCGNSQFZXXWG;
/*INC*/	if (!INC(OCMERJMZIUDTSQ, arg_to)) goto sentence_after_1;
//// ISBRACKET 
...
/*SET*/	r_2 = EPFQDSMVSTMMWW;
//// [ empty ] 
/*ISEMPTY*/	if (OCMERJMZIUDTSQ!=0 && arg_to != OCMERJMZIUDTSQ) goto sentence_after_1;
...
EDQJRLTMYMHYSO->append_copy(l_1, r_1, context); 
...
AZUVJOXYIPMSGU->append_copy(l_2, r_2, context); 
...
/*SET*/	FJIWLCFYWXTEYY = arg_from;
/*INC*/	if (!INC(FJIWLCFYWXTEYY, arg_to)) goto sentence_after_1;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_1;
/*DEF*/	DataCursor r_1;
/*SET*/	l_1 = QDHXWJHIUDGHYX;
/*SET*/	r_1 = QDHXWJHIUDGHYX;
/*JMP*/	goto label_XFVCFBBJJYFSVK_firststep;
label_XFVCFBBJJYFSVK: 
/*INC*/	if (!INC(r_1, YOXBSCEFTDRQEL)) goto sentence_after_1;
...
/*INC*/	if (!INC(VSAPDSHAKGDVHC, YOXBSCEFTDRQEL)) goto label_XFVCFBBJJYFSVK;
	if (! isSymbolType(VSAPDSHAKGDVHC.container->type)) goto label_XFVCFBBJJYFSVK;
/*SET*/	r_A = VSAPDSHAKGDVHC;
//// [ e.1 <any> ] 
/*DEF*/	DataCursor l_2;
/*DEF*/	DataCursor r_2;
/*SET*/	l_2 = r_A;
/*SET*/	r_2 = r_A;
/*JMP*/	goto label_FMCEZTGJCMHXLH_firststep;
label_FMCEZTGJCMHXLH: 
/*INC*/	if (!INC(r_2, YOXBSCEFTDRQEL)) goto label_XFVCFBBJJYFSVK;
label_FMCEZTGJCMHXLH_firststep: 
//// [ &.name <any> ] 
/*DEF*/	DataCursor ASQKAUQLNFHGGT;
/*SET*/	ASQKAUQLNFHGGT = r_2;
 if (!SLIDE(ASQKAUQLNFHGGT, YOXBSCEFTDRQEL, l_A, r_A)) goto label_FMCEZTGJCMHXLH;
//// [ e.1 <any> ] 
/*DEF*/	DataCursor l_3;
/*DEF*/	DataCursor r_3;
/*SET*/	l_3 = ASQKAUQLNFHGGT;
/*SET*/	r_3 = ASQKAUQLNFHGGT;
/*JMP*/	goto label_AGRNFFMNPINWLE_firststep;
label_AGRNFFMNPINWLE: 
/*INC*/	if (!INC(r_3, YOXBSCEFTDRQEL)) goto label_FMCEZTGJCMHXLH;
label_AGRNFFMNPINWLE_firststep: 
//// [ &.name <any> ] 
/*DEF*/	DataCursor XRQXISBFNHJZQV;
/*SET*/	XRQXISBFNHJZQV = r_3;
 if (!SLIDE(XRQXISBFNHJZQV, YOXBSCEFTDRQEL, l_A, r_A)) goto label_AGRNFFMNPINWLE;
//// [ e.1 ] 
/*DEF*/	DataCursor l_4;
/*DEF*/	DataCursor r_4;
/*SET*/	l_4 = XRQXISBFNHJZQV;
/*SET*/	r_4 = YOXBSCEFTDRQEL;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor OXKUKYLZCRUPMI;
/*DEF*/	DataCursor BACPJZSNACLMNU;
/*DEF*/	DataCursor QNBDIFZLUJQVNF;
/*SET*/	OXKUKYLZCRUPMI = FJIWLCFYWXTEYY;
/*INC*/	if (!INC(OXKUKYLZCRUPMI, arg_to)) goto label_AGRNFFMNPINWLE;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_e;
/*DEF*/	DataCursor r_e;
/*SET*/	l_e = BACPJZSNACLMNU;
/*SET*/	r_e = QNBDIFZLUJQVNF;
//// [ empty ] 
/*ISEMPTY*/	if (OXKUKYLZCRUPMI!=0 && arg_to != OXKUKYLZCRUPMI) goto label_AGRNFFMNPINWLE;
...
/*DEF*/	DataCursor RSOSYQHQUHKJCJ;
/*SET*/	JXXVKCZFKZZJQN = arg_from;
/*INC*/	if (!INC(JXXVKCZFKZZJQN, arg_to)) goto sentence_after_2;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_e;
/*DEF*/	DataCursor r_e;
/*SET*/	l_e = AQPOHYGJSJTAKZ;
/*SET*/	r_e = RSOSYQHQUHKJCJ;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor YUGTEDOGFURKXI;
/*DEF*/	DataCursor YQUFOTIAJMWHYI;
/*DEF*/	DataCursor LTHMOEVLWLRXPW;
/*SET*/	YUGTEDOGFURKXI = JXXVKCZFKZZJQN;
/*INC*/	if (!INC(YUGTEDOGFURKXI, arg_to)) goto sentence_after_2;
//// ISBRACKET 
...
/*SET*/	r_1 = YQUFOTIAJMWHYI;
/*JMP*/	goto label_PZHSVBFZVTVHWY_firststep;
label_PZHSVBFZVTVHWY: 
/*INC*/	if (!INC(r_1, LTHMOEVLWLRXPW)) goto sentence_after_2;
...
/*DEF*/	DataCursor r_A;
/*SET*/	l_A = r_1;
/*SET*/	CFZNMAOMAFSYVY = r_1;
/*INC*/	if (!INC(CFZNMAOMAFSYVY, LTHMOEVLWLRXPW)) goto label_PZHSVBFZVTVHWY;
	if (! isSymbolType(CFZNMAOMAFSYVY.container->type)) goto label_PZHSVBFZVTVHWY;
/*SET*/	r_A = CFZNMAOMAFSYVY;
//// [ e.1 <any> ] 
/*DEF*/	DataCursor l_2;
/*DEF*/	DataCursor r_2;
/*SET*/	l_2 = r_A;
/*SET*/	r_2 = r_A;
/*JMP*/	goto label_RQPIZTEUOXGTHF_firststep;
label_RQPIZTEUOXGTHF: 
/*INC*/	if (!INC(r_2, LTHMOEVLWLRXPW)) goto label_PZHSVBFZVTVHWY;
label_RQPIZTEUOXGTHF_firststep: 
//// [ &.name <any> ] 
/*DEF*/	DataCursor XSMXJRWPSURSGW;
/*SET*/	XSMXJRWPSURSGW = r_2;
 if (!SLIDE(XSMXJRWPSURSGW, LTHMOEVLWLRXPW, l_A, r_A)) goto label_RQPIZTEUOXGTHF;
//// [ e.1 <any> ] 
/*DEF*/	DataCursor l_3;
/*DEF*/	DataCursor r_3;
/*SET*/	l_3 = XSMXJRWPSURSGW;
/*SET*/	r_3 = XSMXJRWPSURSGW;
/*JMP*/	goto label_THHILGDHZFZAXA_firststep;
label_THHILGDHZFZAXA: 
/*INC*/	if (!INC(r_3, LTHMOEVLWLRXPW)) goto label_RQPIZTEUOXGTHF;
label_THHILGDHZFZAXA_firststep: 
//// [ &.name <any> ] 
/*DEF*/	DataCursor DTKLHYHQZFDIMS;
/*SET*/	DTKLHYHQZFDIMS = r_3;
 if (!SLIDE(DTKLHYHQZFDIMS, LTHMOEVLWLRXPW, l_A, r_A)) goto label_THHILGDHZFZAXA;
//// [ e.1 ] 
/*DEF*/	DataCursor l_4;
/*DEF*/	DataCursor r_4;
/*SET*/	l_4 = DTKLHYHQZFDIMS;
/*SET*/	r_4 = LTHMOEVLWLRXPW;
//// [ empty ] 
/*ISEMPTY*/	if (YUGTEDOGFURKXI!=0 && arg_to != YUGTEDOGFURKXI) goto label_THHILGDHZFZAXA;
...
/*SET*/	RUEECXKQKRUDLM = arg_from;
/*INC*/	if (!INC(RUEECXKQKRUDLM, arg_to)) goto sentence_after_3;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_1;
/*DEF*/	DataCursor r_1;
/*SET*/	l_1 = ZGDTNHMIVNNKCL;
/*SET*/	r_1 = GARYGYDQDHLTRS;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor THIDZYQAZFNOVK;
/*DEF*/	DataCursor TQCOTCHCOLINEI;
/*DEF*/	DataCursor YTYMRJSCYOEIVD;
/*SET*/	THIDZYQAZFNOVK = RUEECXKQKRUDLM;
/*INC*/	if (!INC(THIDZYQAZFNOVK, arg_to)) goto sentence_after_3;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_2;
/*DEF*/	DataCursor r_2;
/*SET*/	l_2 = TQCOTCHCOLINEI;
/*SET*/	r_2 = YTYMRJSCYOEIVD;
//// [ empty ] 
/*ISEMPTY*/	if (THIDZYQAZFNOVK!=0 && arg_to != THIDZYQAZFNOVK) goto sentence_after_3;
...
/*SET*/	l_1 = arg_from;
/*SET*/	r_1 = arg_from;
/*JMP*/	goto label_YHPHLJZHEZOHMI_firststep;
...
/*SET*/	URCPBLVWAAJIQU = r_1;
/*INC*/	if (!INC(URCPBLVWAAJIQU, arg_to)) goto label_YHPHLJZHEZOHMI;
//// ISBRACKET 
...
/*INC*/	if (!INC(r_3, PRURTYMKKTDBNO)) goto label_YHPHLJZHEZOHMI;
label_XWTTGEEQIMLHCZ_firststep: 
//// [ `a` <any> ] 
/*DEF*/	DataCursor TCTYPHMEQDSUYV;
/*SET*/	TCTYPHMEQDSUYV = r_3;
...
//// [ empty ] 
/*ISEMPTY*/	if (TCTYPHMEQDSUYV!=0 && PRURTYMKKTDBNO != TCTYPHMEQDSUYV) goto label_XWTTGEEQIMLHCZ;
//// [ empty ] 
/*ISEMPTY*/	if (URCPBLVWAAJIQU!=0 && arg_to != URCPBLVWAAJIQU) goto label_XWTTGEEQIMLHCZ;
...
/*SET*/	VOZIMHXXQHDUIQ = arg_from;
/*INC*/	if (!INC(VOZIMHXXQHDUIQ, arg_to)) goto sentence_after_2;
//// ISBRACKET 
...
/*SET*/	QRFPDRSYKHBUTS = EDLNGWGOOOUPNE;
/*INC*/	if (!INC(QRFPDRSYKHBUTS, DKSDGPMHHDAQBS)) goto sentence_after_2;
	if (QRFPDRSYKHBUTS.container->type != text || *(QRFPDRSYKHBUTS.container->value.text + QRFPDRSYKHBUTS.index) != '1') goto sentence_after_2;
//// [ empty ] 
/*ISEMPTY*/	if (QRFPDRSYKHBUTS!=0 && DKSDGPMHHDAQBS != QRFPDRSYKHBUTS) goto sentence_after_2;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor DYFOECQQNLEMKI;
/*DEF*/	DataCursor MIPECEHLBTMBWN;
/*DEF*/	DataCursor KDXYMECLSSHVKM;
/*SET*/	DYFOECQQNLEMKI = VOZIMHXXQHDUIQ;
...
/*DEF*/	DataCursor l_1;
/*DEF*/	DataCursor r_1;
/*SET*/	l_1 = MIPECEHLBTMBWN;
/*SET*/	r_1 = KDXYMECLSSHVKM;
//// [ (<any>) <any> ] 
...
/*DEF*/	DataCursor l_2;
/*DEF*/	DataCursor r_2;
/*SET*/	l_2 = XILJVWLLFPNJZY;
/*SET*/	r_2 = WCPAMEVWTYGFPH;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor IFUBTTNWNPHDBY;
/*DEF*/	DataCursor TWODCLRJPRSEQW;
/*DEF*/	DataCursor RDWSVYNCGFRAZZ;
/*SET*/	IFUBTTNWNPHDBY = YWJXESHOIHMLGV;
/*INC*/	if (!INC(IFUBTTNWNPHDBY, arg_to)) goto sentence_after_2;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_3;
/*DEF*/	DataCursor r_3;
/*SET*/	l_3 = TWODCLRJPRSEQW;
/*SET*/	r_3 = TWODCLRJPRSEQW;
/*JMP*/	goto label_AODGGXWWBTJQUJ_firststep;
label_AODGGXWWBTJQUJ: 
/*INC*/	if (!INC(r_3, RDWSVYNCGFRAZZ)) goto sentence_after_2;
label_AODGGXWWBTJQUJ_firststep: 
//// [ `a` <any> ] 
/*DEF*/	DataCursor RMCDPOMJRYLEDH;
/*SET*/	RMCDPOMJRYLEDH = r_3;
/*INC*/	if (!INC(RMCDPOMJRYLEDH, RDWSVYNCGFRAZZ)) goto label_AODGGXWWBTJQUJ;
...
/*DEF*/	DataCursor l_A;
/*DEF*/	DataCursor r_A;
/*SET*/	l_A = RMCDPOMJRYLEDH;
/*SET*/	UFHWKHZKTNKYTG = RMCDPOMJRYLEDH;
/*INC*/	if (!INC(UFHWKHZKTNKYTG, RDWSVYNCGFRAZZ)) goto label_AODGGXWWBTJQUJ;
	if (! isSymbolType(UFHWKHZKTNKYTG.container->type)) goto label_AODGGXWWBTJQUJ;
/*SET*/	r_A = UFHWKHZKTNKYTG;
//// [ e.1 ] 
/*DEF*/	DataCursor l_4;
/*DEF*/	DataCursor r_4;
/*SET*/	l_4 = r_A;
/*SET*/	r_4 = RDWSVYNCGFRAZZ;
//// [ empty ] 
/*ISEMPTY*/	if (IFUBTTNWNPHDBY!=0 && arg_to != IFUBTTNWNPHDBY) goto label_AODGGXWWBTJQUJ;
...
PVTXDONPEASHNR->append_copy(l_1, r_1, context); 
PVTXDONPEASHNR->append_copy(l_A, r_A, context); 
...
GSOQDJFQTEXYRW->append_copy(l_3, r_3, context); 
GSOQDJFQTEXYRW->append_copy(l_4, r_4, context); 
...
/*SET*/	IZZOEOWAQEZDLM = arg_from;
/*INC*/	if (!INC(IZZOEOWAQEZDLM, arg_to)) goto sentence_after_3;
//// ISBRACKET 
...
/*SET*/	ZOBRIXWXKPICLQ = WAFCOZVQCIEWGK;
/*INC*/	if (!INC(ZOBRIXWXKPICLQ, EKFGRCYVZSAHPS)) goto sentence_after_3;
	if (ZOBRIXWXKPICLQ.container->type != text || *(ZOBRIXWXKPICLQ.container->value.text + ZOBRIXWXKPICLQ.index) != '2') goto sentence_after_3;
//// [ empty ] 
/*ISEMPTY*/	if (ZOBRIXWXKPICLQ!=0 && EKFGRCYVZSAHPS != ZOBRIXWXKPICLQ) goto sentence_after_3;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor BCWLFKFFRLZZMK;
/*DEF*/	DataCursor VMHNLCIVWHWZTZ;
/*DEF*/	DataCursor RBXJCRTUVTXFKI;
/*SET*/	BCWLFKFFRLZZMK = IZZOEOWAQEZDLM;
/*INC*/	if (!INC(BCWLFKFFRLZZMK, arg_to)) goto sentence_after_3;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_1;
/*DEF*/	DataCursor r_1;
/*SET*/	l_1 = VMHNLCIVWHWZTZ;
/*SET*/	r_1 = RBXJCRTUVTXFKI;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor DXHOAFYESYVIZV;
/*DEF*/	DataCursor OZSQORQMQLESIX;
/*DEF*/	DataCursor RNERZOOWRVWPMI;
/*SET*/	DXHOAFYESYVIZV = BCWLFKFFRLZZMK;
/*INC*/	if (!INC(DXHOAFYESYVIZV, arg_to)) goto sentence_after_3;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_2;
/*DEF*/	DataCursor r_2;
/*SET*/	l_2 = OZSQORQMQLESIX;
/*SET*/	r_2 = RNERZOOWRVWPMI;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor BHHYFFUVKOUKDW;
/*DEF*/	DataCursor JCVXQGLSCHJAGQ;
/*DEF*/	DataCursor UEHPNHKYCPMJTG;
/*SET*/	BHHYFFUVKOUKDW = DXHOAFYESYVIZV;
/*INC*/	if (!INC(BHHYFFUVKOUKDW, arg_to)) goto sentence_after_3;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_3;
/*DEF*/	DataCursor r_3;
/*SET*/	l_3 = JCVXQGLSCHJAGQ;
/*SET*/	r_3 = JCVXQGLSCHJAGQ;
/*JMP*/	goto label_LUDHRBEFJJFYTK_firststep;
label_LUDHRBEFJJFYTK: 
/*INC*/	if (!INC(r_3, UEHPNHKYCPMJTG)) goto sentence_after_3;
label_LUDHRBEFJJFYTK_firststep: 
//// [ `a` <any> ] 
/*DEF*/	DataCursor XLBNVMDWSYXHGS;
/*SET*/	XLBNVMDWSYXHGS = r_3;
/*INC*/	if (!INC(XLBNVMDWSYXHGS, UEHPNHKYCPMJTG)) goto label_LUDHRBEFJJFYTK;
...
/*DEF*/	DataCursor l_A;
/*DEF*/	DataCursor r_A;
/*SET*/	l_A = XLBNVMDWSYXHGS;
/*SET*/	CZHYJGDFGNWFPD = XLBNVMDWSYXHGS;
/*INC*/	if (!INC(CZHYJGDFGNWFPD, UEHPNHKYCPMJTG)) goto label_LUDHRBEFJJFYTK;
	if (! isSymbolType(CZHYJGDFGNWFPD.container->type)) goto label_LUDHRBEFJJFYTK;
/*SET*/	r_A = CZHYJGDFGNWFPD;
//// [ e.1 ] 
/*DEF*/	DataCursor l_4;
/*DEF*/	DataCursor r_4;
/*SET*/	l_4 = r_A;
/*SET*/	r_4 = UEHPNHKYCPMJTG;
//// [ empty ] 
/*ISEMPTY*/	if (BHHYFFUVKOUKDW!=0 && arg_to != BHHYFFUVKOUKDW) goto label_LUDHRBEFJJFYTK;
...
OYKIIDFWFXYAAA->append_copy(l_A, r_A, context); 
DataChain* YMOIVFHJLRWYAX = new DataChain(); 
QMSSYGHWDVAEQJ->append(newRefStructBrackets(YMOIVFHJLRWYAX)); 
YMOIVFHJLRWYAX->append_copy(l_3, r_3, context); 
YMOIVFHJLRWYAX->append_copy(l_4, r_4, context); 
...
AWGEURBRNBERAZ->append_copy(l_e, r_e, context); 
...
/*SET*/	SXTKAQUEHJFCEW = arg_from;
/*INC*/	if (!INC(SXTKAQUEHJFCEW, arg_to)) goto sentence_after_1;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_g;
/*DEF*/	DataCursor r_g;
/*SET*/	l_g = CTBFJTPQDLJHEH;
/*SET*/	DZSCSFACXFZXFJ = CTBFJTPQDLJHEH;
/*INC*/	if (!INC(DZSCSFACXFZXFJ, JOBMARGUQWSOKL)) goto sentence_after_1;
	if (! isSymbolType(DZSCSFACXFZXFJ.container->type)) goto sentence_after_1;
/*SET*/	r_g = DZSCSFACXFZXFJ;
//// [ empty ] 
/*ISEMPTY*/	if (r_g!=0 && JOBMARGUQWSOKL != r_g) goto sentence_after_1;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor QOVERSCJZBKMZD;
/*DEF*/	DataCursor NDOSIYHTYAVOXH;
/*DEF*/	DataCursor TAPYEKTUATPRWS;
/*SET*/	QOVERSCJZBKMZD = SXTKAQUEHJFCEW;
/*INC*/	if (!INC(QOVERSCJZBKMZD, arg_to)) goto sentence_after_1;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_1;
/*DEF*/	DataCursor r_1;
/*SET*/	l_1 = NDOSIYHTYAVOXH;
/*SET*/	r_1 = TAPYEKTUATPRWS;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor KXZCZNFDIUEHUW;
/*DEF*/	DataCursor YMTXDRNKLSMDUS;
/*DEF*/	DataCursor KVUTKFIUBZYBLW;
/*SET*/	KXZCZNFDIUEHUW = QOVERSCJZBKMZD;
/*INC*/	if (!INC(KXZCZNFDIUEHUW, arg_to)) goto sentence_after_1;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_n;
/*DEF*/	DataCursor r_n;
/*SET*/	l_n = RFTZLKORIEBSUP;
/*SET*/	r_n = CPXCJWKUVEEREN;
//// [ empty ] 
/*ISEMPTY*/	if (MPARMJDSPXYWXE!=0 && arg_to != MPARMJDSPXYWXE) goto sentence_after_1;
...
FYGAIAIOIIEDBY->append_copy(l_1, r_1, context); 
...
EHFCILQJOEVAJN->append_copy(l_2, r_2, context); 
...
JAPYMUZRPHZLCE->append_copy(l_n, r_n, context); 
...
/*INC*/	if (!INC(GLMVLYQXIXIPVW, arg_to)) goto sentence_after_1;
//// ISBRACKET 
...
/*SET*/	l_e21 = QWXTBFTQSNPAVY;
/*SET*/	r_e21 = QWXTBFTQSNPAVY;
/*JMP*/	goto label_VZWZTJRWOVTTLN_firststep;
label_VZWZTJRWOVTTLN: 
/*INC*/	if (!INC(r_e21, TODPJDPVYQXKSU)) goto sentence_after_1;
...
/*SET*/	l_nn1 = ZISSCCRIFWQBHX;
/*SET*/	r_nn1 = ZISSCCRIFWQBHX;
/*JMP*/	goto label_YKEXQGQOEVJTFR_firststep;
label_YKEXQGQOEVJTFR: 
/*INC*/	if (!INC(r_nn1, YEHKTUSDGZXLAE)) goto label_ZXRXOPENEUXFLG;
label_YKEXQGQOEVJTFR_firststep: 
//// [ &.name <any> ] 
/*DEF*/	DataCursor AMUQGBDNRSMBXR;
/*SET*/	AMUQGBDNRSMBXR = r_nn1;
 if (!SLIDE(AMUQGBDNRSMBXR, YEHKTUSDGZXLAE, l_A, r_A)) goto label_YKEXQGQOEVJTFR;
//// [ e.1 ] 
/*DEF*/	DataCursor l_nn2;
/*DEF*/	DataCursor r_nn2;
/*SET*/	l_nn2 = AMUQGBDNRSMBXR;
/*SET*/	r_nn2 = YEHKTUSDGZXLAE;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor VBTFGLOWFFCTUJ;
/*DEF*/	DataCursor TZQWZGGTLBHROP;
/*DEF*/	DataCursor KWKBBWVNAKWVVD;
/*SET*/	VBTFGLOWFFCTUJ = DFEIMOZYFRQMFO;
/*INC*/	if (!INC(VBTFGLOWFFCTUJ, arg_to)) goto label_YKEXQGQOEVJTFR;
//// ISBRACKET 
...
/*INC*/	if (!INC(YCXCZOZQIWORVP, KWKBBWVNAKWVVD)) goto label_YKEXQGQOEVJTFR;
...
//// [ empty ] 
/*ISEMPTY*/	if (YCXCZOZQIWORVP!=0 && KWKBBWVNAKWVVD != YCXCZOZQIWORVP) goto label_YKEXQGQOEVJTFR;
//// [ e.1 <any> ] 
/*DEF*/	DataCursor l_1;
/*DEF*/	DataCursor r_1;
/*SET*/	l_1 = VBTFGLOWFFCTUJ;
/*SET*/	r_1 = VBTFGLOWFFCTUJ;
/*JMP*/	goto label_NKCXEKJQZVUESW_firststep;
label_NKCXEKJQZVUESW: 
/*INC*/	if (!INC(r_1, arg_to)) goto label_YKEXQGQOEVJTFR;
label_NKCXEKJQZVUESW_firststep: 
//// [ `a` <any> ] 
/*DEF*/	DataCursor QKNZPYVYSDKHSO;
/*SET*/	QKNZPYVYSDKHSO = r_1;
/*INC*/	if (!INC(QKNZPYVYSDKHSO, arg_to)) goto label_NKCXEKJQZVUESW;
...
/*SET*/	ICMHCZOHEFNASL = QKNZPYVYSDKHSO;
/*INC*/	if (!INC(ICMHCZOHEFNASL, arg_to)) goto label_NKCXEKJQZVUESW;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_n;
/*DEF*/	DataCursor r_n;
/*SET*/	l_n = XWXLLXLEWTZUWB;
/*SET*/	r_n = SUVSENEIQWHNEZ;
//// [ empty ] 
/*ISEMPTY*/	if (ICMHCZOHEFNASL!=0 && arg_to != ICMHCZOHEFNASL) goto label_NKCXEKJQZVUESW;
...
/*SET*/	OJKXHORYESUGDH = arg_from;
/*INC*/	if (!INC(OJKXHORYESUGDH, arg_to)) goto sentence_after_2;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_e21;
/*DEF*/	DataCursor r_e21;
/*SET*/	l_e21 = TJCKQJDFGNRDOI;
/*SET*/	r_e21 = TJCKQJDFGNRDOI;
/*JMP*/	goto label_CWFYGKIVBUJFIN_firststep;
label_CWFYGKIVBUJFIN: 
/*INC*/	if (!INC(r_e21, ZPYFMDLQLWQIOD)) goto sentence_after_2;
label_CWFYGKIVBUJFIN_firststep: 
//// [ s.1 <any> ] 
/*DEF*/	DataCursor ZYHCEJCJOJONHG;
/*DEF*/	DataCursor l_A;
/*DEF*/	DataCursor r_A;
/*SET*/	l_A = r_e21;
/*SET*/	ZYHCEJCJOJONHG = r_e21;
/*INC*/	if (!INC(ZYHCEJCJOJONHG, ZPYFMDLQLWQIOD)) goto label_CWFYGKIVBUJFIN;
	if (! isSymbolType(ZYHCEJCJOJONHG.container->type)) goto label_CWFYGKIVBUJFIN;
/*SET*/	r_A = ZYHCEJCJOJONHG;
//// [ e.1 <any> ] 
/*DEF*/	DataCursor l_e22;
/*DEF*/	DataCursor r_e22;
/*SET*/	l_e22 = r_A;
/*SET*/	r_e22 = r_A;
/*JMP*/	goto label_USTQJFNECOLOCM_firststep;
label_USTQJFNECOLOCM: 
/*INC*/	if (!INC(r_e22, ZPYFMDLQLWQIOD)) goto label_CWFYGKIVBUJFIN;
label_USTQJFNECOLOCM_firststep: 
//// [ &.name <any> ] 
/*DEF*/	DataCursor FHPZXTGFPMUSCR;
/*SET*/	FHPZXTGFPMUSCR = r_e22;
 if (!SLIDE(FHPZXTGFPMUSCR, ZPYFMDLQLWQIOD, l_A, r_A)) goto label_USTQJFNECOLOCM;
//// [ e.1 ] 
/*DEF*/	DataCursor l_e23;
/*DEF*/	DataCursor r_e23;
/*SET*/	l_e23 = FHPZXTGFPMUSCR;
/*SET*/	r_e23 = ZPYFMDLQLWQIOD;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor LDURENNLQKWHHY;
/*DEF*/	DataCursor IPQZEVBYKTBVTP;
/*DEF*/	DataCursor WVTTGECAJYLQVU;
/*SET*/	LDURENNLQKWHHY = OJKXHORYESUGDH;
/*INC*/	if (!INC(LDURENNLQKWHHY, arg_to)) goto label_USTQJFNECOLOCM;
//// ISBRACKET 
...
/*INC*/	if (!INC(IZFSOAYXZILJZE, arg_to)) goto label_USTQJFNECOLOCM;
//// ISBRACKET 
...
/*SET*/	GRJMARWUPAYBNQ = HTIFXICKOBIXBB;
/*INC*/	if (!INC(GRJMARWUPAYBNQ, DUZVNGQIAGGCXF)) goto label_HLGDYWDOFNZXQL;
...
//// [ empty ] 
/*ISEMPTY*/	if (GRJMARWUPAYBNQ!=0 && DUZVNGQIAGGCXF != GRJMARWUPAYBNQ) goto label_HLGDYWDOFNZXQL;
//// [ e.1 <any> ] 
/*DEF*/	DataCursor l_1;
/*DEF*/	DataCursor r_1;
/*SET*/	l_1 = ANGODNLXHLSXSH;
/*SET*/	r_1 = ANGODNLXHLSXSH;
/*JMP*/	goto label_LXJECCGQHBCZIB_firststep;
label_LXJECCGQHBCZIB: 
/*INC*/	if (!INC(r_1, arg_to)) goto label_HLGDYWDOFNZXQL;
label_LXJECCGQHBCZIB_firststep: 
//// [ `a` <any> ] 
/*DEF*/	DataCursor HQUFQQXVLLVMTZ;
/*SET*/	HQUFQQXVLLVMTZ = r_1;
/*INC*/	if (!INC(HQUFQQXVLLVMTZ, arg_to)) goto label_LXJECCGQHBCZIB;
...
/*SET*/	HFMBEZPLHQAKBM = HQUFQQXVLLVMTZ;
...
/*DEF*/	DataCursor l_n;
/*DEF*/	DataCursor r_n;
/*SET*/	l_n = MVAFQYXJYEXDSS;
/*SET*/	r_n = WBJIOUYMHLZCLT;
//// [ empty ] 
/*ISEMPTY*/	if (HFMBEZPLHQAKBM!=0 && arg_to != HFMBEZPLHQAKBM) goto label_LXJECCGQHBCZIB;
...
/*DEF*/	DataCursor l_e1;
/*DEF*/	DataCursor r_e1;
/*SET*/	l_e1 = IDPMVKHOZHKDUC;
/*SET*/	r_e1 = OMLGLTLVEINNCA;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor IKNSUGJQCCASDX;
/*DEF*/	DataCursor DAZCRTVLLKFVTE;
/*DEF*/	DataCursor ZAZZCSCTLEGENL;
/*SET*/	IKNSUGJQCCASDX = JUDOBFUOIWUBGE;
/*INC*/	if (!INC(IKNSUGJQCCASDX, arg_to)) goto sentence_after_3;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_e21;
/*DEF*/	DataCursor r_e21;
/*SET*/	l_e21 = DAZCRTVLLKFVTE;
/*SET*/	r_e21 = DAZCRTVLLKFVTE;
/*JMP*/	goto label_LTVKZDQOWGOLJP_firststep;
label_LTVKZDQOWGOLJP: 
/*INC*/	if (!INC(r_e21, ZAZZCSCTLEGENL)) goto sentence_after_3;
...
/*DEF*/	DataCursor r_A;
/*SET*/	l_A = r_e21;
/*SET*/	DSYQNCSDJSDCXX = r_e21;
/*INC*/	if (!INC(DSYQNCSDJSDCXX, ZAZZCSCTLEGENL)) goto label_LTVKZDQOWGOLJP;
	if (! isSymbolType(DSYQNCSDJSDCXX.container->type)) goto label_LTVKZDQOWGOLJP;
/*SET*/	r_A = DSYQNCSDJSDCXX;
//// [ e.1 <any> ] 
/*DEF*/	DataCursor l_e22;
/*DEF*/	DataCursor r_e22;
/*SET*/	l_e22 = r_A;
/*SET*/	r_e22 = r_A;
/*JMP*/	goto label_YRGHRWPQINXMRI_firststep;
label_YRGHRWPQINXMRI: 
/*INC*/	if (!INC(r_e22, ZAZZCSCTLEGENL)) goto label_LTVKZDQOWGOLJP;
label_YRGHRWPQINXMRI_firststep: 
//// [ &.name <any> ] 
/*DEF*/	DataCursor DXPDPQUNVKWXRY;
/*SET*/	DXPDPQUNVKWXRY = r_e22;
 if (!SLIDE(DXPDPQUNVKWXRY, ZAZZCSCTLEGENL, l_A, r_A)) goto label_YRGHRWPQINXMRI;
//// [ e.1 ] 
/*DEF*/	DataCursor l_e23;
/*DEF*/	DataCursor r_e23;
/*SET*/	l_e23 = DXPDPQUNVKWXRY;
/*SET*/	r_e23 = ZAZZCSCTLEGENL;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor KXTLXYPPFMAJFH;
/*DEF*/	DataCursor QYUDWTIGBJTMQM;
/*DEF*/	DataCursor DLTCQZGCAIWSWF;
/*SET*/	KXTLXYPPFMAJFH = IKNSUGJQCCASDX;
/*INC*/	if (!INC(KXTLXYPPFMAJFH, arg_to)) goto label_YRGHRWPQINXMRI;
//// ISBRACKET 
...
/*INC*/	if (!INC(VPSDWELPDJMMBP, ABRADQEELKPKEC)) goto label_YRYHCWWIARUHII;
...
//// [ empty ] 
/*ISEMPTY*/	if (VPSDWELPDJMMBP!=0 && ABRADQEELKPKEC != VPSDWELPDJMMBP) goto label_YRYHCWWIARUHII;
//// [ e.1 <any> ] 
/*DEF*/	DataCursor l_1;
/*DEF*/	DataCursor r_1;
/*SET*/	l_1 = DQTESOJACQHNWD;
/*SET*/	r_1 = DQTESOJACQHNWD;
/*JMP*/	goto label_CUGGHONUCWEGVF_firststep;
label_CUGGHONUCWEGVF: 
/*INC*/	if (!INC(r_1, arg_to)) goto label_YRYHCWWIARUHII;
label_CUGGHONUCWEGVF_firststep: 
//// [ `a` <any> ] 
/*DEF*/	DataCursor JZBDWKBEVKGDWU;
/*SET*/	JZBDWKBEVKGDWU = r_1;
/*INC*/	if (!INC(JZBDWKBEVKGDWU, arg_to)) goto label_CUGGHONUCWEGVF;
...
/*SET*/	BTJVTOQOTHGGTD = JZBDWKBEVKGDWU;
/*INC*/	if (!INC(BTJVTOQOTHGGTD, arg_to)) goto label_CUGGHONUCWEGVF;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_n;
/*DEF*/	DataCursor r_n;
/*SET*/	l_n = RDOLGJMFUBZZPN;
/*SET*/	r_n = HJAQWOTZQBLHMR;
//// [ empty ] 
/*ISEMPTY*/	if (BTJVTOQOTHGGTD!=0 && arg_to != BTJVTOQOTHGGTD) goto label_CUGGHONUCWEGVF;
...
JTMRCJIVHSYTNW->append_copy(l_n, r_n, context); 
...
MQQJVMOHFYESQX->append_copy(l_A, r_A, context); 
...
XLOZMCQMVHTCEX->append_copy(l_n, r_n, context); 
...
/*SET*/	AMEYKVIXDAQVSS = arg_from;
/*INC*/	if (!INC(AMEYKVIXDAQVSS, arg_to)) goto sentence_after_4;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_e21;
/*DEF*/	DataCursor r_e21;
/*SET*/	l_e21 = DWWOEDKLQENAFB;
/*SET*/	r_e21 = DWWOEDKLQENAFB;
/*JMP*/	goto label_HDVRBNLBLSEEND_firststep;
label_HDVRBNLBLSEEND: 
/*INC*/	if (!INC(r_e21, CFNHWRHDKJCSXO)) goto sentence_after_4;
...
/*DEF*/	DataCursor r_A;
/*SET*/	l_A = r_e21;
/*SET*/	UBKXAORTEJLRCM = r_e21;
/*INC*/	if (!INC(UBKXAORTEJLRCM, CFNHWRHDKJCSXO)) goto label_HDVRBNLBLSEEND;
	if (! isSymbolType(UBKXAORTEJLRCM.container->type)) goto label_HDVRBNLBLSEEND;
/*SET*/	r_A = UBKXAORTEJLRCM;
//// [ e.1 <any> ] 
/*DEF*/	DataCursor l_e22;
/*DEF*/	DataCursor r_e22;
/*SET*/	l_e22 = r_A;
...
/*INC*/	if (!INC(r_e22, CFNHWRHDKJCSXO)) goto label_HDVRBNLBLSEEND;
label_CVOVRSQRCOPNNP_firststep: 
//// [ &.name <any> ] 
/*DEF*/	DataCursor KUNKKCPOENVPKV;
/*SET*/	KUNKKCPOENVPKV = r_e22;
 if (!SLIDE(KUNKKCPOENVPKV, CFNHWRHDKJCSXO, l_A, r_A)) goto label_CVOVRSQRCOPNNP;
//// [ e.1 ] 
/*DEF*/	DataCursor l_e23;
/*DEF*/	DataCursor r_e23;
/*SET*/	l_e23 = KUNKKCPOENVPKV;
/*SET*/	r_e23 = CFNHWRHDKJCSXO;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor YGUNPABOUJVIRE;
/*DEF*/	DataCursor LEHLGECTNAZVQP;
/*DEF*/	DataCursor SOUUBCPYFIKGQT;
/*SET*/	YGUNPABOUJVIRE = AMEYKVIXDAQVSS;
/*INC*/	if (!INC(YGUNPABOUJVIRE, arg_to)) goto label_CVOVRSQRCOPNNP;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_e1;
/*DEF*/	DataCursor r_e1;
/*SET*/	l_e1 = LEHLGECTNAZVQP;
/*SET*/	r_e1 = SOUUBCPYFIKGQT;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor UFVQQEVCPCJPMJ;
/*DEF*/	DataCursor HPUACSIASPTSKQ;
/*DEF*/	DataCursor YHITAUZFABLPQL;
/*SET*/	UFVQQEVCPCJPMJ = YGUNPABOUJVIRE;
/*INC*/	if (!INC(UFVQQEVCPCJPMJ, arg_to)) goto label_CVOVRSQRCOPNNP;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_nn1;
/*DEF*/	DataCursor r_nn1;
/*SET*/	l_nn1 = HPUACSIASPTSKQ;
/*SET*/	r_nn1 = HPUACSIASPTSKQ;
/*JMP*/	goto label_KUKAHMLIVZAPRO_firststep;
label_KUKAHMLIVZAPRO: 
/*INC*/	if (!INC(r_nn1, YHITAUZFABLPQL)) goto label_CVOVRSQRCOPNNP;
label_KUKAHMLIVZAPRO_firststep: 
//// [ &.name <any> ] 
/*DEF*/	DataCursor TLQDIUOEEYKIQZ;
/*SET*/	TLQDIUOEEYKIQZ = r_nn1;
 if (!SLIDE(TLQDIUOEEYKIQZ, YHITAUZFABLPQL, l_A, r_A)) goto label_KUKAHMLIVZAPRO;
//// [ e.1 ] 
/*DEF*/	DataCursor l_nn2;
/*DEF*/	DataCursor r_nn2;
/*SET*/	l_nn2 = TLQDIUOEEYKIQZ;
/*SET*/	r_nn2 = YHITAUZFABLPQL;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor AHFAVZZRFRZZEM;
/*DEF*/	DataCursor IYZVOBXUOJORAW;
/*DEF*/	DataCursor URHJOPPNNCTEHR;
/*SET*/	AHFAVZZRFRZZEM = UFVQQEVCPCJPMJ;
/*INC*/	if (!INC(AHFAVZZRFRZZEM, arg_to)) goto label_KUKAHMLIVZAPRO;
//// ISBRACKET 
...
/*SET*/	ULPGKOZUYWMOBC = IYZVOBXUOJORAW;
/*INC*/	if (!INC(ULPGKOZUYWMOBC, URHJOPPNNCTEHR)) goto label_KUKAHMLIVZAPRO;
...
//// [ empty ] 
/*ISEMPTY*/	if (ULPGKOZUYWMOBC!=0 && URHJOPPNNCTEHR != ULPGKOZUYWMOBC) goto label_KUKAHMLIVZAPRO;
//// [ e.1 <any> ] 
/*DEF*/	DataCursor l_1;
/*DEF*/	DataCursor r_1;
/*SET*/	l_1 = AHFAVZZRFRZZEM;
/*SET*/	r_1 = AHFAVZZRFRZZEM;
/*JMP*/	goto label_LVQTAMMEMHQPYI_firststep;
label_LVQTAMMEMHQPYI: 
/*INC*/	if (!INC(r_1, arg_to)) goto label_KUKAHMLIVZAPRO;
label_LVQTAMMEMHQPYI_firststep: 
//// [ `a` <any> ] 
/*DEF*/	DataCursor OWMNLQAEFZSIOT;
/*SET*/	OWMNLQAEFZSIOT = r_1;
/*INC*/	if (!INC(OWMNLQAEFZSIOT, arg_to)) goto label_LVQTAMMEMHQPYI;
...
/*SET*/	PXJWOCJEUMCJDQ = OWMNLQAEFZSIOT;
/*INC*/	if (!INC(PXJWOCJEUMCJDQ, arg_to)) goto label_LVQTAMMEMHQPYI;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_n;
/*DEF*/	DataCursor r_n;
/*SET*/	l_n = SZRRRUGIMNJBJA;
/*SET*/	r_n = LQLRCEZJFXCHWD;
//// [ empty ] 
/*ISEMPTY*/	if (PXJWOCJEUMCJDQ!=0 && arg_to != PXJWOCJEUMCJDQ) goto label_LVQTAMMEMHQPYI;
...
DVDLRWAMNKYXJS->append_copy(l_n, r_n, context); 
...
XPFDLZEHBGKVYP->append_copy(l_A, r_A, context); 
...
DXONZMNJVLRJXR->append_copy(l_1, r_1, context); 
...
KPFERAYXDZNPGK->append_copy(l_n, r_n, context); 
...
/*SET*/	SDFPDJOBICQFQM = arg_from;
/*INC*/	if (!INC(SDFPDJOBICQFQM, arg_to)) goto sentence_after_5;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_e1;
/*DEF*/	DataCursor r_e1;
/*SET*/	l_e1 = FSTQHPFMCPMFDC;
/*SET*/	r_e1 = DCCMODLQJQGWJO;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor FNUQNPMHDVKZEB;
/*DEF*/	DataCursor NLIGKJFSWCXWCU;
/*DEF*/	DataCursor JWHEPDBSGTFFKB;
/*SET*/	FNUQNPMHDVKZEB = SDFPDJOBICQFQM;
/*INC*/	if (!INC(FNUQNPMHDVKZEB, arg_to)) goto sentence_after_5;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_e2;
/*DEF*/	DataCursor r_e2;
/*SET*/	l_e2 = NLIGKJFSWCXWCU;
/*SET*/	r_e2 = JWHEPDBSGTFFKB;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor YKEUHNFZNGKPMV;
/*DEF*/	DataCursor QTHEJJRBZHRCGG;
/*DEF*/	DataCursor OEWVRXBWYSZBLQ;
/*SET*/	YKEUHNFZNGKPMV = FNUQNPMHDVKZEB;
/*INC*/	if (!INC(YKEUHNFZNGKPMV, arg_to)) goto sentence_after_5;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_nn;
/*DEF*/	DataCursor r_nn;
/*SET*/	l_nn = QTHEJJRBZHRCGG;
/*SET*/	r_nn = OEWVRXBWYSZBLQ;
//// [ e.1 ] 
/*DEF*/	DataCursor l_hn;
/*DEF*/	DataCursor r_hn;
/*SET*/	l_hn = YKEUHNFZNGKPMV;
/*SET*/	r_hn = arg_to;
...
GPWJPLTJFRQCOC->append_copy(l_hn, r_hn, context); 
...
/*DEF*/	DataCursor r_A;
/*SET*/	l_A = arg_from;
/*SET*/	QXYLUTTLWHTZAS = arg_from;
/*INC*/	if (!INC(QXYLUTTLWHTZAS, arg_to)) goto sentence_after_1;
	if (! isSymbolType(QXYLUTTLWHTZAS.container->type)) goto sentence_after_1;
/*SET*/	r_A = QXYLUTTLWHTZAS;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor NQEOYJBXKIQMAJ;
/*DEF*/	DataCursor AGFHZZFBDVFUYU;
/*DEF*/	DataCursor RLVURNWRAMCADU;
/*SET*/	NQEOYJBXKIQMAJ = r_A;
/*INC*/	if (!INC(NQEOYJBXKIQMAJ, arg_to)) goto sentence_after_1;
//// ISBRACKET 
...
/*SET*/	NWUGTUESHXMGZV = AGFHZZFBDVFUYU;
/*INC*/	if (!INC(NWUGTUESHXMGZV, RLVURNWRAMCADU)) goto sentence_after_1;
	if (NWUGTUESHXMGZV.container->type != text || *(NWUGTUESHXMGZV.container->value.text + NWUGTUESHXMGZV.index) != '1') goto sentence_after_1;
//// [ empty ] 
/*ISEMPTY*/	if (NWUGTUESHXMGZV!=0 && RLVURNWRAMCADU != NWUGTUESHXMGZV) goto sentence_after_1;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor VIVOWLZIVLIICZ;
/*DEF*/	DataCursor PUSSWAFKENWEMO;
/*DEF*/	DataCursor CIMLMSLEBFIIAR;
/*SET*/	VIVOWLZIVLIICZ = NQEOYJBXKIQMAJ;
/*INC*/	if (!INC(VIVOWLZIVLIICZ, arg_to)) goto sentence_after_1;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_1;
/*DEF*/	DataCursor r_1;
/*SET*/	l_1 = PUSSWAFKENWEMO;
/*SET*/	r_1 = CIMLMSLEBFIIAR;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor GFMUABIZMYQPTH;
/*DEF*/	DataCursor DMZEIEGQCJTSJH;
/*DEF*/	DataCursor QKMVWZEDALKJDV;
/*SET*/	GFMUABIZMYQPTH = VIVOWLZIVLIICZ;
/*INC*/	if (!INC(GFMUABIZMYQPTH, arg_to)) goto sentence_after_1;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_2;
/*DEF*/	DataCursor r_2;
/*SET*/	l_2 = DMZEIEGQCJTSJH;
/*SET*/	r_2 = QKMVWZEDALKJDV;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor MZGRXOKCHGOALG;
/*DEF*/	DataCursor UQCNQYROKQMJSZ;
/*DEF*/	DataCursor JWSDGCOFGLCQGD;
/*SET*/	MZGRXOKCHGOALG = GFMUABIZMYQPTH;
/*INC*/	if (!INC(MZGRXOKCHGOALG, arg_to)) goto sentence_after_1;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_n1;
/*DEF*/	DataCursor r_n1;
/*SET*/	l_n1 = UQCNQYROKQMJSZ;
/*SET*/	r_n1 = UQCNQYROKQMJSZ;
/*JMP*/	goto label_NDBYPQQIDCLZXS_firststep;
label_NDBYPQQIDCLZXS: 
/*INC*/	if (!INC(r_n1, JWSDGCOFGLCQGD)) goto sentence_after_1;
label_NDBYPQQIDCLZXS_firststep: 
//// [ &.name <any> ] 
/*DEF*/	DataCursor QBJWIPLOXDERKL;
/*SET*/	QBJWIPLOXDERKL = r_n1;
 if (!SLIDE(QBJWIPLOXDERKL, JWSDGCOFGLCQGD, l_A, r_A)) goto label_NDBYPQQIDCLZXS;
//// [ e.1 ] 
/*DEF*/	DataCursor l_n2;
/*DEF*/	DataCursor r_n2;
/*SET*/	l_n2 = QBJWIPLOXDERKL;
/*SET*/	r_n2 = JWSDGCOFGLCQGD;
//// [ empty ] 
/*ISEMPTY*/	if (MZGRXOKCHGOALG!=0 && arg_to != MZGRXOKCHGOALG) goto label_NDBYPQQIDCLZXS;
...
JNWRWEBGELZBGI->append_copy(l_1, r_1, context); 
JNWRWEBGELZBGI->append_copy(l_A, r_A, context); 
DataChain* QDSCWTSBXXZKGH = new DataChain(); 
GBXGOGNWYUNRNU->append(newRefStructBrackets(QDSCWTSBXXZKGH)); 
QDSCWTSBXXZKGH->append_copy(l_2, r_2, context); 
DataChain* SKGEXLEVGXNYDQ = new DataChain(); 
GBXGOGNWYUNRNU->append(newRefStructBrackets(SKGEXLEVGXNYDQ)); 
SKGEXLEVGXNYDQ->append_copy(l_n1, r_n1, context); 
SKGEXLEVGXNYDQ->append_copy(l_n2, r_n2, context); 
...
/*SET*/	IGPQMWFONTEPRC = QNRNAZCRFHPBJM;
/*INC*/	if (!INC(IGPQMWFONTEPRC, RFBYQMHDABALHT)) goto sentence_after_2;
	if (IGPQMWFONTEPRC.container->type != text || *(IGPQMWFONTEPRC.container->value.text + IGPQMWFONTEPRC.index) != '2') goto sentence_after_2;
//// [ empty ] 
/*ISEMPTY*/	if (IGPQMWFONTEPRC!=0 && RFBYQMHDABALHT != IGPQMWFONTEPRC) goto sentence_after_2;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor VLZMJBMWEOILEJ;
/*DEF*/	DataCursor RPKSBXEESTGPSM;
/*DEF*/	DataCursor NMALPUSWIBUBAQ;
/*SET*/	VLZMJBMWEOILEJ = AUYICCQDMFIEJR;
/*INC*/	if (!INC(VLZMJBMWEOILEJ, arg_to)) goto sentence_after_2;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_1;
/*DEF*/	DataCursor r_1;
/*SET*/	l_1 = RPKSBXEESTGPSM;
/*SET*/	r_1 = NMALPUSWIBUBAQ;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor VOTCAYTBTUZDTW;
/*DEF*/	DataCursor SYSJRVRWGIXZHX;
/*DEF*/	DataCursor WHIUHVQTKJPQZY;
/*SET*/	VOTCAYTBTUZDTW = VLZMJBMWEOILEJ;
/*INC*/	if (!INC(VOTCAYTBTUZDTW, arg_to)) goto sentence_after_2;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_2;
/*DEF*/	DataCursor r_2;
/*SET*/	l_2 = SYSJRVRWGIXZHX;
/*SET*/	r_2 = WHIUHVQTKJPQZY;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor YHHTXMJFMQLFWZ;
/*DEF*/	DataCursor JFQVBENLERLKYA;
/*DEF*/	DataCursor WOLVBTYZGEWXCC;
/*SET*/	YHHTXMJFMQLFWZ = VOTCAYTBTUZDTW;
/*INC*/	if (!INC(YHHTXMJFMQLFWZ, arg_to)) goto sentence_after_2;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_n1;
/*DEF*/	DataCursor r_n1;
/*SET*/	l_n1 = JFQVBENLERLKYA;
/*SET*/	r_n1 = JFQVBENLERLKYA;
/*JMP*/	goto label_HSWMWGHBBANCUE_firststep;
label_HSWMWGHBBANCUE: 
/*INC*/	if (!INC(r_n1, WOLVBTYZGEWXCC)) goto sentence_after_2;
label_HSWMWGHBBANCUE_firststep: 
//// [ &.name <any> ] 
/*DEF*/	DataCursor JVMWGSFFVOWDLR;
/*SET*/	JVMWGSFFVOWDLR = r_n1;
 if (!SLIDE(JVMWGSFFVOWDLR, WOLVBTYZGEWXCC, l_A, r_A)) goto label_HSWMWGHBBANCUE;
//// [ e.1 ] 
/*DEF*/	DataCursor l_n2;
/*DEF*/	DataCursor r_n2;
/*SET*/	l_n2 = JVMWGSFFVOWDLR;
/*SET*/	r_n2 = WOLVBTYZGEWXCC;
//// [ empty ] 
/*ISEMPTY*/	if (YHHTXMJFMQLFWZ!=0 && arg_to != YHHTXMJFMQLFWZ) goto label_HSWMWGHBBANCUE;
...
TXKCWEAGYDMHRP->append_copy(l_1, r_1, context); 
DataChain* YQUIMWRBVEZZVV = new DataChain(); 
YINXFIWFHTLDYT->append(newRefStructBrackets(YQUIMWRBVEZZVV)); 
YQUIMWRBVEZZVV->append_copy(l_2, r_2, context); 
YQUIMWRBVEZZVV->append_copy(l_A, r_A, context); 
DataChain* JPGIHCYFQZVADT = new DataChain(); 
YINXFIWFHTLDYT->append(newRefStructBrackets(JPGIHCYFQZVADT)); 
JPGIHCYFQZVADT->append_copy(l_n1, r_n1, context); 
JPGIHCYFQZVADT->append_copy(l_n2, r_n2, context); 
...
/*DEF*/	DataCursor l_s;
/*DEF*/	DataCursor r_s;
/*SET*/	l_s = QHVAPGYSGGXDOR;
/*SET*/	FYIDTTGGSDYJBV = QHVAPGYSGGXDOR;
/*INC*/	if (!INC(FYIDTTGGSDYJBV, KVMVQEXPJFGVPI)) goto sentence_after_1;
	if (! isSymbolType(FYIDTTGGSDYJBV.container->type)) goto sentence_after_1;
/*SET*/	r_s = FYIDTTGGSDYJBV;
//// [ empty ] 
/*ISEMPTY*/	if (r_s!=0 && KVMVQEXPJFGVPI != r_s) goto sentence_after_1;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor OLBMCGBRRVKUPT;
/*DEF*/	DataCursor ANLZOSCTFNYSZK;
/*DEF*/	DataCursor LRNZRKUXYJPWWM;
/*SET*/	OLBMCGBRRVKUPT = DFYEMFQVYNBDLR;
/*INC*/	if (!INC(OLBMCGBRRVKUPT, arg_to)) goto sentence_after_1;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_1;
/*DEF*/	DataCursor r_1;
/*SET*/	l_1 = ANLZOSCTFNYSZK;
/*SET*/	r_1 = LRNZRKUXYJPWWM;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor INHPLXGXWULGXH;
/*DEF*/	DataCursor LMSBZRQUAJUAXP;
/*DEF*/	DataCursor DPSMWIWXXDVIPO;
/*SET*/	INHPLXGXWULGXH = OLBMCGBRRVKUPT;
/*INC*/	if (!INC(INHPLXGXWULGXH, arg_to)) goto sentence_after_1;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_2;
/*DEF*/	DataCursor r_2;
/*SET*/	l_2 = LMSBZRQUAJUAXP;
/*SET*/	r_2 = DPSMWIWXXDVIPO;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor UXTLKQWWOWRQEA;
/*DEF*/	DataCursor TQBMMILPOXBIPW;
/*DEF*/	DataCursor WEGHTFIQJQKBNJ;
/*SET*/	UXTLKQWWOWRQEA = INHPLXGXWULGXH;
/*INC*/	if (!INC(UXTLKQWWOWRQEA, arg_to)) goto sentence_after_1;
//// ISBRACKET 
...
//// [ empty ] 
/*ISEMPTY*/	if (TQBMMILPOXBIPW!=0 && WEGHTFIQJQKBNJ != TQBMMILPOXBIPW) goto sentence_after_1;
//// [ empty ] 
/*ISEMPTY*/	if (UXTLKQWWOWRQEA!=0 && arg_to != UXTLKQWWOWRQEA) goto sentence_after_1;
...
/*SET*/	HXDKUNEBQGRIZK = arg_from;
/*INC*/	if (!INC(HXDKUNEBQGRIZK, arg_to)) goto sentence_after_2;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_s;
/*DEF*/	DataCursor r_s;
/*SET*/	l_s = EKGERQQLYYFESO;
/*SET*/	EFRMTWKYLNONCH = EKGERQQLYYFESO;
/*INC*/	if (!INC(EFRMTWKYLNONCH, YKMVAYQBNKSTMD)) goto sentence_after_2;
	if (! isSymbolType(EFRMTWKYLNONCH.container->type)) goto sentence_after_2;
/*SET*/	r_s = EFRMTWKYLNONCH;
//// [ empty ] 
/*ISEMPTY*/	if (r_s!=0 && YKMVAYQBNKSTMD != r_s) goto sentence_after_2;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor IGMTFBOURZHMFF;
/*DEF*/	DataCursor FSRCBDZDFBEOST;
/*DEF*/	DataCursor FVSKREBTLJHZKR;
/*SET*/	IGMTFBOURZHMFF = HXDKUNEBQGRIZK;
...
/*DEF*/	DataCursor l_3;
/*DEF*/	DataCursor r_3;
/*SET*/	l_3 = NYMOPFWPNFUZEI;
/*SET*/	r_3 = NYMOPFWPNFUZEI;
/*JMP*/	goto label_AFAWQGQBTDGFFC_firststep;
label_AFAWQGQBTDGFFC: 
/*INC*/	if (!INC(r_3, HXYXANSPRGGWDY)) goto sentence_after_2;
label_AFAWQGQBTDGFFC_firststep: 
//// [ `a` <any> ] 
/*DEF*/	DataCursor EGTPCYBQVRQUSQ;
/*SET*/	EGTPCYBQVRQUSQ = r_3;
/*INC*/	if (!INC(EGTPCYBQVRQUSQ, HXYXANSPRGGWDY)) goto label_AFAWQGQBTDGFFC;
	if (EGTPCYBQVRQUSQ.container->type != text || *(EGTPCYBQVRQUSQ.container->value.text + EGTPCYBQVRQUSQ.index) != '>') goto label_AFAWQGQBTDGFFC;
//// [ empty ] 
/*ISEMPTY*/	if (EGTPCYBQVRQUSQ!=0 && HXYXANSPRGGWDY != EGTPCYBQVRQUSQ) goto label_AFAWQGQBTDGFFC;
//// [ empty ] 
...
/*SET*/	NOPFYMRMQHUCGO = arg_from;
/*INC*/	if (!INC(NOPFYMRMQHUCGO, arg_to)) goto sentence_after_3;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_s;
/*DEF*/	DataCursor r_s;
/*SET*/	l_s = MDIUXEMXBZYSLV;
/*SET*/	HGPMPRKCYFDXKM = MDIUXEMXBZYSLV;
/*INC*/	if (!INC(HGPMPRKCYFDXKM, LITWUBNSPBMEWW)) goto sentence_after_3;
	if (! isSymbolType(HGPMPRKCYFDXKM.container->type)) goto sentence_after_3;
/*SET*/	r_s = HGPMPRKCYFDXKM;
//// [ empty ] 
/*ISEMPTY*/	if (r_s!=0 && LITWUBNSPBMEWW != r_s) goto sentence_after_3;
//// [ (<any>) <any> ] 
/*DEF*/	DataCursor TUHEVOIXRWLMXW;
/*DEF*/	DataCursor GCNOYZMMYOVRTE;
/*DEF*/	DataCursor PQTIBDVTHMPOAQ;
/*SET*/	TUHEVOIXRWLMXW = NOPFYMRMQHUCGO;
/*INC*/	if (!INC(TUHEVOIXRWLMXW, arg_to)) goto sentence_after_3;
//// ISBRACKET 
...
/*DEF*/	DataCursor l_1;
/*DEF*/	DataCursor r_1;
/*SET*/	l_1 = LCEONIYVQVURDI;
/*SET*/	r_1 = LCEONIYVQVURDI;
/*JMP*/	goto label_NUGEAJDGZSJEWS_firststep;
label_NUGEAJDGZSJEWS: 
/*INC*/	if (!INC(r_1, AQMSRTFGWTPEPU)) goto sentence_after_3;
label_NUGEAJDGZSJEWS_firststep: 
//// [ `a` <any> ] 
/*DEF*/	DataCursor QRMJZSSBXJVOTJ;
/*SET*/	QRMJZSSBXJVOTJ = r_1;
/*INC*/	if (!INC(QRMJZSSBXJVOTJ, AQMSRTFGWTPEPU)) goto label_NUGEAJDGZSJEWS;
...
/*SET*/	l_sss = QRMJZSSBXJVOTJ;
/*SET*/	VJQCFQPTBZGKET = QRMJZSSBXJVOTJ;
/*INC*/	if (!INC(VJQCFQPTBZGKET, AQMSRTFGWTPEPU)) goto label_NUGEAJDGZSJEWS;
	if (! isSymbolType(VJQCFQPTBZGKET.container->type)) goto label_NUGEAJDGZSJEWS;
/*SET*/	r_sss = VJQCFQPTBZGKET;
//// [ e.1 ] 
/*DEF*/	DataCursor l_2;
/*DEF*/	DataCursor r_2;
/*SET*/	l_2 = r_sss;
...
//// [ empty ] 
/*ISEMPTY*/	if (IJQLGJYCJPKPXF!=0 && arg_to != IJQLGJYCJPKPXF) goto label_NUGEAJDGZSJEWS;
...
/*SET*/	l_sIY = arg_from;
/*SET*/	r_sIY = arg_from;
/*JMP*/	goto label_YQKTDMKAPSPBMY_firststep;
...
/*SET*/	KOYLPNZOIPZWDM = r_sIY;
/*INC*/	if (!INC(KOYLPNZOIPZWDM, arg_to)) goto label_YQKTDMKAPSPBMY;
//// ISBRACKET 
...
//// [ empty ] 
/*ISEMPTY*/	if (KOYLPNZOIPZWDM!=0 && arg_to != KOYLPNZOIPZWDM) goto label_YQKTDMKAPSPBMY;
...
LUIBJGNQQLFEWI->append_copy(l_sIY, r_sIY, context); 
...
OAMGMRCEMOAXVU->append_copy(l_1, r_1, context); 
