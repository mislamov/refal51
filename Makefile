...
CFLAGS = -Wall 
INCLUDES = 
LDFLAGS = -lxerces-c  -s -Wl,--allow-multiple-definition
RCFLAGS = 
...
Debug_target.BIN = bin\Debug\direfal-010.exe
Debug_target.OBJ = src\SAXLoader.o src\SAXLoaderHandlers.o src\data.o src\direfal.o src\function.o src\main.o src\program.o src\session.o src\symbols.o src\system.o src\variables.o 
DEP_FILES += src\SAXLoader.d src\SAXLoaderHandlers.d src\data.d src\direfal.d src\function.d src\main.d src\program.d src\session.d src\symbols.d src\system.d src\variables.d 
...
Release_target.BIN = bin\Release\direfal-010.exe
Release_target.OBJ = src\SAXLoader.o src\SAXLoaderHandlers.o src\data.o src\direfal.o src\function.o src\main.o src\program.o src\session.o src\symbols.o src\system.o src\variables.o 
DEP_FILES += src\SAXLoader.d src\SAXLoaderHandlers.d src\data.d src\direfal.d src\function.d src\main.d src\program.d src\session.d src\symbols.d src\system.d src\variables.d 
