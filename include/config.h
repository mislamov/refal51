...
#define AchtungERRORs()		SYSTEMERRORs("Achtung!")
#define notrealisedERRORs()	SYSTEMERRORs("Not realised!")
#define unexpectedERRORs()	SYSTEMERRORs("Unexpected execution!")
